...
>> ○ **Proof:** Assume $f$ is a first-degree (linear) function and show that equality holds on the unit interval.
...
>> ○ More accurate numerical integration technique than the trapezoidal rule.

>> ○ **Proof:** Assume $f$ is a second-degree (quadratic/parabolic) function and show that equality holds on the unit interval.
...
>> ○ Even more accurate than Simpson's rule.

>> ○ **Proof:** Assume $f$ is a third-degree (cubic) function and show that equality holds on the unit interval.
...
<img width="251" height="66" alt="스크린샷 2025-09-08 오전 10 14 33" src="https://github.com/user-attachments/assets/5dff8b04-b77d-4148-98a9-3b72d9858d61" />
...
<img width="233" height="81" alt="스크린샷 2025-09-08 오전 10 14 54" src="https://github.com/user-attachments/assets/9a29347c-3b52-4283-8ab4-ed74671d4c7e" />
