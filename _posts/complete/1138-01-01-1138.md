...
> ① Overview: Fewer features reduce computational complexity, less likely to be overfitting, but more complex tasks are difficult to handle
...
>> ○ Examples: Conditional probability, classification, regression functions, supervised classification.

>> ○ Advantages

>>> ○ Generates output data from previous experience

>>> ○ Uses experience to optimize performance criteria

>>> ○ Helps solve various types of problems

>>> ○ Computational complexity: relatively simple

>>> ○ Accuracy: very accurate

>> ○ Disadvantages
 
>>> ○ Must use labeled data for the output

>>> ○ Generally takes a long time

>>> ○ For big data, it may take an extremely long time
...
>>> ○ Does not require separate labels

>> ○ Disadvantages

>>> ○ Computational complexity: quite complex

>>> ○ Accuracy: somewhat less accurate
...
>>> ○ **Example:** [TabPFN](https://arxiv.org/abs/2207.01848) (Tabular Foundation Model), [Temporal Foundation Model](https://arxiv.org/pdf/2310.10688) 
...
>> ○ Developed in 1958 by John McCarthy at MIT.

>> ○ Introduced modern high-level language concepts such as tree data structures, dynamic typing, recursion, conditionals, automatic memory management (garbage collection), and higher-order functions.

 >> ○ The first language designed for AI research.

> ② Python

>> ○ Officially released in 1991 by Guido van Rossum at CWI.

>> ○ Implements inheritance, exception handling, functions, and modules, and was influenced by LISP.

>> ○ A modern essential language for AI research/development.

> ③ Java

>> ○ Used for tools such as natural language processing (CoreNLP), tensor operations (ND4J), and GPU-accelerated deep learning stacks (DL4J).
...
>> ○ The volume of a hypersphere approaches 0 as the dimension increases beyond n > 2π. V<sub>n</sub> = (2π/n) V<sub>n-2</sub>.
...
>> ○ The model fails to learn the patterns in the data sufficiently.
...
>> ○ A phenomenon in which a model’s previously acquired knowledge or ability to perform earlier tasks deteriorates substantially when it is further trained on new data or new tasks.

>> ○ Solution: [Replay buffer](https://jb243.github.io/pages/2162#3-markov-decision-process)
...
⑴ **Preparation Period (1943–1956)**

> ① Concept of propositional logic

> ② Turing Test

> ③ First chess program (Dietrich Prinz)

⑵ **Early Development Period (1956–1974)**

> ① The term “Artificial Intelligence” coined (Dartmouth Conference)
...
> ③ Development of the LISP language (McCarthy)

> ④ Publication of *Perceptrons* (1969, Minsky & Papert)

>> ○ **1969:** Marvin Minsky and Seymour Papert published *Perceptrons*, highlighting limitations and triggering the first AI “winter.”

⑶ **First AI Winter (1974–1980)**

> ① The XOR problem, which cannot be solved by linear separation

⑷ Growth Period (1980–1987)

> ① Development of the XCON expert system

> ② Hopfield network (John Hopfield)

>> ○ **1982:** John Hopfield proposed the Hopfield network, reviving interest in neural networks.

> ③ Multilayer perceptron (Geoffrey Hinton)

> ④ Proposal of backpropagation (Seppo Linnainmaa)

> ⑤ Application of backpropagation to neural networks (Paul Werbos)

> ⑥ Popularization of backpropagation (Geoffrey Hinton, Rumelhart)

>> ○ **1986:** Geoffrey Hinton and colleagues popularized backpropagation, enabling the training of deep neural networks.

⑸ **Second AI Winter (1987–1993)**

> ① Vanishing gradients, increased computational cost, slow learning, etc.

⑹ **Stabilization Period (1993–2011)**

> ① ReLU, Dropout, etc. (Geoffrey Hinton) + advances in hardware (GPUs, etc.)

⑺ **Revival Period (2011–Present)**

> ① Deep learning and ImageNet

>> ○ **2012:** Geoffrey Hinton achieved 1st place with the lowest error rate in the “ImageNet Challenge (ILSVRC),” highlighting the importance of GPUs.

> ② Google projects (Andrew Ng)

> ③ World Go champion (AlphaGo, AlphaGo Zero, etc.)
