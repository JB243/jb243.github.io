...
First, it is enough to prove it for $\(a_1,\ldots,a_n>0\)$ (otherwise we replace $\(a_1,a_2,\ldots,a_n\)$ with $\(|a_1|,|a_2|,\ldots,|a_n|\)$, which have product $\(1\)$, while the right-hand side increases).
