...
**4.** [Catalan Numbers](#4-catalan-numbers)
...
<img width="294" height="416" alt="스크린샷 2025-12-07 오후 9 41 31" src="https://github.com/user-attachments/assets/53ca49c7-b711-4e37-85da-721926d402a4" />
...
>> ○ (Total number of paths) = number of ways to choose n steps out of 2n steps = <sub>2n</sub>C<sub>n</sub>

>> ○ A bad path is a path that reaches level –1 at some point; if we reflect the remaining part of the path after the first time it reaches –1, every bad path corresponds one-to-one with a path that eventually reaches level –2 → (Number of bad paths) = <sub>2n</sub>C<sub>n+1</sub>

>> ○ (Number of Dyck paths) = Catalan number C<sub>k</sub> 

<br>

<img width="333" height="46" alt="스크린샷 2025-12-07 오후 9 42 49" src="https://github.com/user-attachments/assets/b72f0ac8-4ff0-4c0e-8a9c-e638068bb2cd" />
...
>  ④ **Property 1.** 4<sup>k</sup> ≥ C<sub>k</sub> ≥ 2<sup>2k+1</sup> / (4k<sup>2</sup> + 6<sub>k</sub> + 2)
...
>> ○ That is, it can be expressed as follows where C<sub>k</sub> is the Catalan number:

<br>

<img width="302" height="73" alt="스크린샷 2025-12-07 오후 9 45 31" src="https://github.com/user-attachments/assets/b0f16c1d-46ff-4b79-a879-707355d25896" />

<br>

> ② **Property 1.** lim<sub>n→∞</sub> a<sub>n</sub> <sup>1/n</sup> = 3 ([proof](https://nate9389.tistory.com/2466#:~:text=%EA%B5%AC%ED%95%A0%20%EC%88%98%20%EC%97%86%EC%97%88%EB%8B%A4.-,7,-.%20%EC%96%91%EC%9D%98%20%EC%A0%95%EC%88%98))
