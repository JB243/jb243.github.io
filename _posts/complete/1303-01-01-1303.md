...
**S405.** $C_{\text{min}} = \frac{1}{2(n-1)}$, $C_{\text{max}} = \frac{1}{2}$
...
**P406.** Let $a, b, c$ be the lengths of the sides of a triangle. Find the constant $C$ such that the following equation holds for all $a, b, c$:
