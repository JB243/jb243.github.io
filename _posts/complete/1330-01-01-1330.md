...
> ⑥ Steric Number 6: sp<sup>3</sup>d<sup>2</sup>. Unshared electron pairs cause significant repulsion, so they are placed in one direction (e.g., the vertical direction) to minimize repulsion.
