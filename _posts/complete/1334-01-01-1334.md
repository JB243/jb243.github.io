...
> ① Broad sense: A probability distribution describing where electrons are likely to be found in atoms and molecules. Also known as wave function.
...
>> ○ A concept like the orbital’s phase—i.e., the direction of an electron’s rotation that makes up the orbital.
...
<img width="283" height="29" alt="스크린샷 2025-12-29 오전 2 03 38" src="https://github.com/user-attachments/assets/06c11c3b-c245-4771-99c4-02b0f4e993c3" />
...
<img width="203" height="55" alt="스크린샷 2025-12-29 오전 2 03 49" src="https://github.com/user-attachments/assets/f2d0bdf8-6fd6-4779-9f24-d3ee2ffec24d" />
...
<img width="369" height="186" alt="스크린샷 2025-12-29 오전 2 04 05" src="https://github.com/user-attachments/assets/9760ffb2-9b46-4450-a74b-e7dd84dc5da5" />
...
<img width="607" height="376" alt="스크린샷 2025-12-29 오전 2 04 22" src="https://github.com/user-attachments/assets/48cbc1e1-4f09-4fbd-a281-0aeea7bc65c9" />
...
<img width="678" height="149" alt="스크린샷 2025-12-29 오전 2 04 45" src="https://github.com/user-attachments/assets/da5fffba-802c-48e0-bfc3-9d23198b3071" />
...
<img width="333" height="485" alt="스크린샷 2025-12-29 오전 2 05 02" src="https://github.com/user-attachments/assets/34fdacdf-c695-42d7-b0bf-450137a122f1" />
...
<img width="696" height="466" alt="스크린샷 2025-12-29 오전 2 05 22" src="https://github.com/user-attachments/assets/5f044207-7d44-445c-90a5-8d91a201910b" />
...
<img width="484" height="429" alt="스크린샷 2025-12-29 오전 2 05 38" src="https://github.com/user-attachments/assets/78b607de-343e-4284-858a-6d3b49cf80b6" />
...
<img width="484" height="425" alt="스크린샷 2025-12-29 오전 2 05 49" src="https://github.com/user-attachments/assets/43505a32-5d3d-41ed-9438-76a938f6d7e9" />
...
<img width="573" height="355" alt="스크린샷 2025-12-29 오전 2 06 31" src="https://github.com/user-attachments/assets/4d91be9b-9ee8-4e2c-8442-e0250110db66" />
...
<img width="646" height="341" alt="스크린샷 2025-12-29 오전 2 06 15" src="https://github.com/user-attachments/assets/21fde683-f183-4403-b9cc-cc6673e2acba" />
...
<img width="637" height="335" alt="스크린샷 2025-12-29 오전 2 07 04" src="https://github.com/user-attachments/assets/b05e3d93-ca85-41be-9e95-90bed94c8050" />
...
<img width="623" height="330" alt="스크린샷 2025-12-29 오전 2 07 18" src="https://github.com/user-attachments/assets/a0e7751b-ab49-4685-9e17-70206d56756a" />
...
<img width="582" height="550" alt="스크린샷 2025-12-29 오전 2 07 33" src="https://github.com/user-attachments/assets/7ec246de-926f-47b1-8d1d-20b0e5cd2328" />

**Figure 12.** Molecular orbitals of diene

<br>

⑸ [Hückel Approximation](https://www.youtube.com/watch?v=oT71KYCPSJE) (Hückel Method)

> ① Definition: A method for predicting MO energies and resonance energy of cyclic or acyclic polyenes.

> ② Basic equation: ㅣH<sub>ij</sub> - E S<sub>ij</sub>ㅣ<sub>n×n</sub> = 0 (where ㅣ·ㅣ denotes a determinant)

>> ○ n: number of MOs

>> ○ For simplification, assume S<sub>ii</sub>=1 and S<sub>ij</sub>=0 for i ≠ j

>> ○ H<sub>ij</sub>: the effect of the i-th carbon on the j-th carbon position

>> ○ H<sub>ii</sub> = α (Coulomb integral). α is the energy of the carbon 2p orbital (approximately −11 eV or −1100 kJ/mol)

>> ○ H<sub>ij</sub> = β (for i ≠ j) (resonance integral). For polyenes, β is approximately 10% of α

>> ○ α, β < 0 : represent negative potential energy

> ③ Energy calculation

>> ○ Total energy: Fill MO electrons starting from the lowest energies obtained from the basic equation, then take the sum.

>> ○ π-electron energy = (number of double bonds) × (2α + 2β)

>> ○ Delocalization (resonance) energy = total energy − π-electron energy − (number of isolated electrons) × α

> ④ **Example 1.** Ethene

<br>

<img width="158" height="108" alt="스크린샷 2025-12-29 오전 1 51 29" src="https://github.com/user-attachments/assets/ea247117-b05c-4e36-a19b-7d9d37b45e45" />

<br>

>> ○ E=α ± β

>> ○ Number of MO electrons =2

>> ○ Total energy = 2(α + β) = 2α + 2β

>> ○ π-electron energy = 2α + 2β

>> ○ Delocalization energy = (2α + 2β) - (2α + 2β) = 0

> ⑤ **Example 2.** 1,3-Butadiene

<br>

<img width="267" height="168" alt="스크린샷 2025-12-29 오전 1 55 48" src="https://github.com/user-attachments/assets/82d88922-1d72-4817-8890-6fb6cd0a69e6" />

<br>

>> ○ E = α ± 1.618β, α ± 0.618β

>> ○ Number of MO electrons = 4

>> ○ Total energy = 2 × (α + 1.618 β) + 2 × (α + 0.618 β) = 4α + 4.472 β

>> ○ π-electron energy = 2 × (2α + 2β) = 4α + 4β

>> ○ Delocalization energy = (4α + 4.472 β) - (4α + 4β) = 0.472 β

> ⑥ **Example 3.** Cyclopropenyl

<br>

<img width="212" height="252" alt="스크린샷 2025-12-29 오전 1 56 04" src="https://github.com/user-attachments/assets/edcacb24-dfda-4c99-b9aa-ba613299777a" />
...
>> ○ Total energy = 2 × (α + 2β) = 2α + 4β

>> ○ π-electron energy = 2α + 2β

>> ○ Delocalization energy = (2α + 4β) - (2α + 2β) = 2β (∴ aromaticity)

> ⑦ **Example 4.** Benzene

<br>

<img width="357" height="252" alt="스크린샷 2025-12-29 오전 1 56 20" src="https://github.com/user-attachments/assets/8d8b6e91-ebd3-4114-b690-1ba1756af1ee" />

<br>

>> ○ E = α + 2β, α + β, α + β, α – β, α – β, α - 2β

>> ○ Number of MO electrons = 6

>> ○ Total energy = 2 × (α + 2β) + 4 × (α + β) = 6 α + 8 β

>> ○ π-electron energy = 3 × (2 α + 2β) = 6 α + 6 β

>> ○ Delocalization energy = (6 α + 8 β) - (6 α + 6 β) = 2 β (∴ aromaticity)

> ⑧ **Example 5.** Trimethylenemethane

<br>

<img width="258" height="268" alt="스크린샷 2025-12-29 오전 1 56 36" src="https://github.com/user-attachments/assets/16a0cd66-2a33-43a6-9e7e-edf338bf6040" />
...
>> ○ Total energy = 2 × (α + √3 β) + 2 × α = 4α + 2√3 β

>> ○ π-electron energy = 2α + 2β

>> ○ Isolated-electron energy = 2α

>> ○ Delocalization energy = (4α + 2√3 β ) - (2α + 2β ) - 2α = (2√3 - 2)β

> ⑨ **Example 6.** Allyl radical

<br>

<img width="192" height="138" alt="스크린샷 2025-12-29 오전 1 56 51" src="https://github.com/user-attachments/assets/2712df59-0d0c-4b75-9a25-279a01b6580a" />

<br>

>> ○ E = α ± √2 β, α

>> ○ Number of MO electrons = 3

>> ○ Total energy = 2 × (α +√2 β) + α = 3α + 2√2β

>> ○ π-electron energy = 2α + 2β

>> ○ Isolated-electron energy = α

>> ○ Delocalization energy = (3α + 2√2β ) - (2α + 2β ) - α = (2√2 - 2)β
