...
>> ○ When there are multiple substituents, give the lowest number to the carbon with a substituent, even if it's one fewer
...
>>>> ○ Exception: If a substituent has another substituent, consider the latter when determining alphabetical order
...
>> ○ The carbon attached to the substituent is labeled as carbon 1
