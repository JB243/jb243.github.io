## **Chapter 6. Common Organic Reactions**
...
> ① Alpha Carbon (α carbon): Carbon directly attached to the functional group (e.g., X-) 

> ② Alpha Hydrogen (α hydrogen): Hydrogen attached to the alpha carbon

> ③ Beta Carbon (β carbon): Carbon adjacent to the alpha carbon

> ④ Beta Hydrogen (β hydrogen): Hydrogen attached to the beta carbon
...
⑴ Comparing Nucleophilicities of Ions with Similar Rings but Different Periods: Larger period implies stronger nucleophilicity

> ① Example: CH<sub>3</sub>O<sup>-</sup> < CH<sub>3</sub>S<sup>-</sup>

⑵ Comparing Nucleophilicities of Neutral Nucleophiles: Larger atoms have greater polarizability, leading to stronger nucleophilicity
...
>> ○ Acid-base reactions should not proceed in polar solvents
