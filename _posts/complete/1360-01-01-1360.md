...
⑴ Reaction **:** Formation of products by breaking the bonds of reactants and forming bonds of products
...
>> ○ Spontaneous reactions are not particularly significant in organic chemistry anyway
...
>> ○ Since the exact nature of the transition state is unknown, reactions are inferred from reactants or products.
...
>> ○ Reactions leading to intermediate formation are generally endothermic; the transition state favoring a more stable intermediate is speculated to be more similar to the intermediate → hence the reaction proceeds quickly
...
> ① Homolysis **:** Radical reactions, occurs in symmetric bonds and C-H bonds
...
> ② Heterolysis **:** Polar reactions, caused by differences in electronegativity or polarity
