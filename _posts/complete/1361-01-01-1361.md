...
**3.** [S<sub>N</sub>2 Reaction](#3-sn2-reaction-bimolecular-nucleophilic-substitution--2nd-order-simultaneous-reaction-resembles-playing-with-beads)

**4.** [S<sub>N</sub>1 Reaction](#4-sn1-reaction-unimolecular-nucleophilic-substitution--1st-order-remove-and-react-leading-to-carbocation)

**5.** [E2 Reaction](#5-e2-reaction-bimolecular-elimination--2nd-order-hence-a-simultaneous-reaction)

**6.** [E1 Reaction](#6-e1-reaction-unimolecular-elimination--break-the-molecule-into-parts-since-it-s-first-order-forming-a-carbocation)

**7.** [E1cB Reaction](#7-e1cb-reaction-unimolecular-elimination-conjugate-base)

**8.** [Bred't rule](#8-bredt-rule)
...
## **3\. S<sub>N</sub>2 Reaction** (Bimolecular Nucleophilic Substitution): 2<sup>nd</sup> order, simultaneous reaction, resembles playing with beads
...
**Figure 7.** Formation of the orbital with empty electrons from nucleophilic side and anti-bonding orbital
...
>> ○ Issue: Iodine ion S<sub>N</sub>2 reaction is reversible due to similar nucleophilicity and basicity of iodine ion, leading to coexistence of reactants and products (e.g., CH<sub>3</sub>Br + I<sup>-</sup> ⇄ CH<sub>3</sub>I + Br<sup>-</sup>)
...
>> ○ Issue: Fluoride ion's strong ionic nature makes it difficult to dissolve in nonpolar solvents

>> ○ As a result, S<sub>N</sub>2 reaction involving fluoride is less likely

>> ○ Solution: Using catalysts like crown ethers can introduce chlorine ions into nonpolar solvents
...
## **4\. S<sub>N</sub>1 Reaction** (Unimolecular Nucleophilic Substitution): 1st order, remove and react, leading to carbocation
...
> ② Resonance stabilization causes faster reaction in the case of formation of resonance-stabilized carbocation intermediates compared to the same degree
...
> ① The faster the leaving group, the weaker the carbon-bond connection or the more stable the leaving anion, the faster the rate

> ② Leaving ability is inversely proportional to the basicity of the leaving group

⑼ Reaction rate factors: Catalyst

> ① Ag<sup>+</sup> enhances the rate of S<sub>N</sub>1 reaction by promoting the departure of the leaving group through its bonding to the leaving group, accelerating its dissociation.

<br>

<br>

## **5. E2 Reaction** (bimolecular elimination): 2nd order, hence a simultaneous reaction
...
>>> ○ For exothermic reactions, the energy order is reactants ＜ products ＜ transition state, so the transition state structure resembles the products.

>>> ○ For endothermic reactions, the energy order is products ＜ reactants ＜ transition state, so the transition state structure resembles the reactants.
...
>>> ○ Hammond's Postulate doesn't apply to all reactions, including E2 reactions.
...
>>> ○ E2 reaction of cyclohexane halides: Occurs in the major product with _chair-form_ as reference due to _anti_ -addition.
...
>> ○ Rate comparison: Polar positive solvent ＜ Aprotic solvent ＜ Polar negative solvent
...
> ⑤ Influence on Neighboring Hydrogen Substitution

>> ○ Neighboring hydrogens are bulky, hindering carbon-hydrogen bond cleavage.

>> ○ Since hydrogen elimination is the rate-determining step for E2 reactions, the presence of neighboring hydrogens slows down the reaction rate.
...
## **6\. E1 Reaction** (unimolecular elimination): Break the molecule into parts since it's first-order, forming a carbocation
...
>> ○ 3° benzyl ≃ 3° alkyl ＞ 2° benzyl ≃ 2° alkyl ≃ 3° ＞ 1° benzyl ≃ 1° alkyl ≃ 2° ＞ 1° ＞ methyl ＞ vinyl carbocations
...
>> ○ Aprotic solvent ＜ Polar aprotic solvent ＜ Polar protic solvent

<br>

<br>

## **7\. E1cB Reaction** (unimolecular elimination conjugate base)
...
## **11\. Carbon-Carbon Coupling Reactions** (Organic Synthesis)
