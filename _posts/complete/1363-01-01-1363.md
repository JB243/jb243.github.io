...
>> ○ Increasing triple bond leads to higher s-character in the bond → tendency to be closer to the nucleus → shorter bond lengths
...
>>> ○ **Reason 3.** The strength of pi bonding in triple bonds is weaker than in alkenes, promoting greater dipole moments through increased van der Waals forces

>> ○ **Principle 4.** Internal alkenes and alkynes have higher boiling points than terminal ones

>>> ○ Reason: Terminal alkenes and alkynes have higher solubility in water

> ② Melting Point

>> ○ **Principle 1.** Similar to boiling points, longer chain length and larger surface area lead to higher melting points, similar to alkanes
...
>> ○ Vicinal Alkenes: _trans_ is more stable than _cis_ due to steric hindrance ( **∵** conformational hindrance)

>> ○ [Cyclic Alkenes](https://jb243.github.io/pages/1412)

>>> ○ Cyclooctene [8] ~ Cycloundecene [11]: cis is more stable than trans due to conformational strain
...
## 2. [Chain Alkenes and Alkynes Nomenclature](https://jb243.github.io/pages/1357) 

⑴ Selection of Main Chain

> ① Assuming functional groups are alkyl, halogen, alkene, and alkyne

> ② Alkenes and alkynes take priority over alkynes, so the longest carbon chain containing alkene or alkyne determines the main chain, and the rest are considered substituents
...
>> ○ Only indicate the first carbon where a multiple bond starts

>> ○ Example: 4-methyl-2-pentene

> ③ When two numbering options are possible, assign numbers to alkenes or alkynes to minimize the numbers
...
> ⑤ When both numbering combinations are still possible and there's a single substituent, assign the lowest number to the carbon bearing the substituent

> ⑥ When both numbering combinations are still possible and there are multiple substituents, assign the lowest number to the carbon(s) bearing the substituents

> ⑦ If numbers are still the same, assign the lower number to the substituent in alphabetical order
...
>> ○ Example: hept-1-ene doesn't end with -a, but hexa-1,3-diene retains -a

<br>

<br>

## 3. [Cyclic Alkenes and Alkynes Nomenclature](https://jb243.github.io/pages/1357)
...
> ① Assign numbers so that alkene/alkyne carbon 1 is between carbon 1 and carbon 2 of the main chain
...
> ① **(Formula)** Attach H+ to a carbon with more hydrogens, rearrange positions, and then add X- considering ring closure.
...
>>> ○ Significance: Reaction of achiral molecules leading to chiral intermediates and chiral products.
...
>> ○ In the case of unsymmetrical alkenes, carbon atoms with more substituents don't bear a full positive charge, unlike halogen atoms.
...
>> ○ Halogenation reaction occurs from alkenes to alkynes because of their reactivity.

> ④ Stereochemistry

>> ○ Backside attack: X<sup>-</sup> that was removed due to steric hindrance undergoes a backside attack.
...
>>> ○ The chair-form creates steric hindrance due to the ring intermediate, leading to unexpected steric hindrance and product distribution.
...
> ① **(Formula)** Halogenation addition reaction: Attach X<sup>+</sup> first, then _anti_ addition of OH.
...
>> ○ OH<sup>-</sup> isn't very labile, so while thermodynamically favorable, it might not occur kinetically.
...
>> ○ In the carbocation state, carbons bearing more alkyl groups are partially positively charged, so partial positive charge resides.
...
> ② **(Formula)** 1. BH<sub>3</sub>, THF; 2. H<sub>2</sub>O<sub>2</sub>, OH<sup>-</sup> conditions involve the addition of H2B-H to HO-H with _syn_ addition.
...
>> ○ **Reason 2.** Partial stabilization of quasi-carbocation.
...
>> ○ Faster reaction rates for alkenes with smaller steric hindrance ( **∵** Steric hindrance is crucial)
...
>> ○ **Step 1:** Carbene formation reaction: CH<sub>2</sub>I<sub>2</sub> (catalyst: Zn(Cu) + ether) → ICH<sub>2</sub>ZnI (carbenoid) → H<sub>2</sub>C:
...
## **5. Alkene's Nucleophilic Reactions**
