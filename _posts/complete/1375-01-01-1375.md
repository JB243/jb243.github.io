...
> ① Derived from alkane with the most carbon atoms

> ② Name the remaining portion other than the parent chain as alkoxy

> ③ Number the carbons in the parent chain with alkoxy group connected as 1

> ④ If there are substituents in the parent chain, name them in alphabetical order
...
> ① Also called phase transfer agents, ion carriers, quaternary ammonium salts, cryptands

> ② Named as 3n-crown-n-ether due to the repeating CH<sub>2</sub>CH<sub>2</sub>O structure

> ③ Form complexes with different ions based on their sizes: Can transport cations after coordination, in nonpolar solvents
...
⑶ Alkoxy Mercuryation-Demercuration

> ① Overview

>> ○ Useful when Williamson Ether Synthesis is not applicable

>> ○ Alkoxy mercuryation-demercuration is Markovnikov hydration where ROH is the reactant

>> ○ Similar to [oxymercuration-demercuration](https://jb243.github.io/pages/1363) of alkenes

> ② **(Formula)** Reaction under Hg(O<sub>2</sub>CCF<sub>3</sub>)<sub>2</sub>, ROH, NaBH<sub>4</sub>, HO<sup>-</sup> conditions
...
**Figure 5.** Mechanism of Alkoxy Mercuryation-Demercuration

<br>

>> ○ Hg exposes inner electrons to create a cyclic intermediate

>> ○ ROH, being a weak nucleophile, performs an S<sub>N</sub>1-like reaction, attacking the carbocation with multiple substitutions
