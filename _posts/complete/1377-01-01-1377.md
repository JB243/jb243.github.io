...
>> ○ Ketones are more polar than aldehydes: Ketones stabilize carbocations in resonance contributors by methyl groups
...
> ② However, differences in reactivity between aldehydes and ketones are observed in oxidation-reduction reactions
...
**Figure 11.** Corey-Seebach reaction
...
>>> ○ Equilibrium is possible for the reverse reaction, named at specific points of equilibrium
...
>>> ○ **Secondary amines** lack a proton to remove from the iminium ion, unlike primary amines, so they remove hydrogen attached to the alpha carbon
...
**Figure 21.** Addition reaction of aldehydes and ketones with metal reagents
...
> ② **Example 2.** Wittig reaction: Addition reaction of aldehydes and ketones with ylide
...
>>> ○ If the ylide nucleophile's carbon is attached to an electron-withdrawing group (EWG), less reactive alkene, thermodynamically stable alkene is predominantly formed

>>> ○ If the ylide nucleophile's carbon is attached to a phenyl group, a more favorable alkene is formed in terms of stereochemistry (steric hindrance ↓)
...
>>> ○ **Step 1.** Add reducing substance to Tollens reagent and heat

>>> ○ **Step 2.** Reduction of silver ion, which was in ion form, leads to the precipitation of Ag(s)

>> ○ Reduction: Formation of metallic silver

>> ○ Aldehyde: Formation of metallic silver

>>> ○ Ag<sub>2</sub>O acts as an Ag<sup>+</sup> donor: oxygen in water moves to form an aldehyde, resulting in the creation of a carboxylic acid.
...
>>> ○ **Step 2.** Reduction of copper ion, which was in ion form with tartaric acid, leads to the precipitation of cuprous oxide (Cu2O)

>> ○ Reduction: Formation of copper precipitate (red-brown)
...
>>> ○ Aldehydes and ketones are oxidized to esters and carboxylic acids, respectively
