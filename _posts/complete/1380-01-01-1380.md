...
⑶ **Reaction 2.** Acid–Base Reaction

> ① **Reaction 2-1.** General Acid–Base Reaction

> ② **Reaction 2-2.** Mitsunobu Esterification

>> ○ **(Note)** The carboxylic acid is converted to the corresponding carboxylate, which then undergoes an S<sub>N</sub>2 reaction.

>> ○ Under PPh<sub>3</sub>/DEAD in THF, the reactive intermediate formed from the PPh<sub>3</sub>–DEAD pair behaves as a base, enabling ester formation and producing the reduced DEAD byproduct and PPh<sub>3</sub>=O.

<br>

<img width="654" height="316" alt="스크린샷 2026-02-17 오전 11 34 43" src="https://github.com/user-attachments/assets/41cd5843-b202-4ca9-9c96-0bfe8cebb8c1" />

**Figure 15.** Mitsunobu Esterification

<br>


⑷ **Reaction 3.** Other Reactions

> ① **Reaction 3-1.** Hell-Vollhard-Zelinsky Reaction (HVZ Reaction)
...
> ② **Reaction 3-2.** Hundsdiecker Reaction: RCOOAg + Br<sub>2</sub>, CCl<sub>4</sub> → R-Br

> ③ **Reaction 3-3.** Kochi Reaction: A variation of the Hundsdiecker Reaction. RCOOH + Pb(OAC)<sub>4</sub>, + LiCl - CO<sub>2</sub> → R-Cl + LiPb(OAc)<sub>3</sub> + HOAc

> ④ **Reaction 3-4.** After converting the carboxylic acid to its dianion form, an alkylation reaction occurs at the alpha position. 1. NaH, 55 ℃, THF, 2. LDA, 10-35 ℃
...
**Figure 16.** Alkoxide and Carboxylic Acid
...
**Figure 17.** Grignard Reagent and Carboxylic Acid
...
**Figure 19.** Carbonation Reaction Types of Grignard Reagent **Type 1**
...
**Figure 20.** Mechanism of amide formation reaction
...
**Figure 21.** Curtius rearrangement mechanism (applications)
...
**Figure 22.** Wolff rearrangement mechanism
...
**Figure 23.** Acyl chloride synthesis using carboxylic acid and SOCl<sub>2</sub>
...
**Figure 24.** Formation of carboxylic acid through hydrolysis of anhydride
...
**Figure 25.** Esterification reaction of anhydride
...
**Figure 26.** Amide formation reaction
...
**Figure 28.** Furan undergoing Friedel-Crafts acylation
...
**Figure 29.** Fluorescein synthesis
...
**Figure 30.** Acid anhydride synthesis
...
**Figure 31.** Ester hydrolysis reaction mechanism
...
**Figure 32.** Saponification reaction mechanism
...
**Figure 33.** Trans-esterification reaction
...
**Figure 34.** Reaction leading to amide formation with amines
...
**Figure 35.** Alcohol formation reaction with LAH
...
**Figure 36.** NaBH<sub>4</sub> reduction reaction equation
...
**Figure 37.** Reduction reaction with DIBAL-H
...
**Figure 38.** Tertiary alcohol formation reaction with Grignard reagent addition
...
**Figure 39.** Ester decarboxylation reaction
...
**Figure 40.** Claisen rearrangement reaction of orthoester
...
**Figure 41.** Acid-catalyzed amide hydrolysis reaction
...
**Figure 42.** Base-catalyzed amide hydrolysis reaction
...
**Figure 43.** Reaction mechanism of amine formation from amide using LiAlH<sub>4</sub>
...
**Figure 44.** Hofmann rearrangement reaction
...
**Figure 45.** Bischler-Napieralski reaction
...
**Figure 48.** Acid-catalyzed hydrolysis mechanism
...
**Figure 49.** Amine formation via LAH (LiAlH4)
...
**Figure 50.** Aldehyde formation via DIBAL-H
...
**Figure 51.** Hydrogenation with Raney nickel catalyst
...
**Figure 52.** Ketone formation by adding Grignard reagent
...
**Figure 53.** 1,3-dipolar cycloaddition
...
**Figure 54.** Cycloaddition with azide and cyclooctyne
...
**Figure 55.** Cycloaddition with tetrazine and _trans_-cyclooctene
