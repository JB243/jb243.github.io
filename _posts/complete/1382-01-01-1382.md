...
> ① Ketones and esters: 11

> ② Diketones: 13

> ③ Amides: 15 (hydrogen on the nitrogen side)

> ④ Aldehydes: 17

> ⑤ Ketones: 20

> ⑥ Esters: 25. Alpha hydrogens are more acidic in ketones and aldehydes compared to esters
...
> ⑤ Esters, carboxylic acids, and amides do not undergo tautomerization like ketones and aldehydes
...
> ① Kinetic control: Influenced by steric effects, occurs at low temperatures (e.g., -76 °C)
...
> ② Thermodynamic control: Influenced by stability of poly-substituted alkene intermediates
...
>> ○ 2<sup>nd</sup> reaction conditions, HCl, H<sub>2</sub>O, act as a proton source to convert O<sup>-</sup> to OH
...
> ③ Usually, hydroxide can react due to poor leaving ability but is highlighted by the resonance stabilization of the conjugate base
...
>> ○ A carbonyl compound is most effective in a nucleophilic addition reaction when it is more reactive and cannot form an enolate anion.

>> ○ (**Formula**) The hydrogen at the same alpha position of the carbonyl is removed twice.

>> ○ (**Formula**) Resonance stabilization results in the =O being displaced by OH-.

>> ○ (**Formula**) An alpha carbon of one carbonyl attacks another ketone carbon, removing the double-bonded oxygen; however, unsaturation is maintained, so a double bond must be formed between that carbonyl alpha carbon and the other ketone carbon.
...
>> ○ In this reaction, two types of paired nucleophiles can create 5-membered and 7-membered rings.

>> ○ Among them, the 5-membered ring is more stable, so the paired nucleophiles are formed to create the 5-membered ring.
...
>>> ○ Removal of α-hydrogen of OH<sup>-</sup> prefers 3,3-dimethylbutan-2-one, which is present in small amounts during the reaction.

>>> ○ Dehydrogenated 3,3-dimethylbutan-2-one reacts with the excess other aldehyde.

>>> ○ Without a small amount of 3,3-dimethylbutan-2-one, a simple aldol condensation reaction can occur.
...
> ⑥ **Example 5.** Knoevenagel Condensation: Utilizing an activated methylene group

> ⑦ **Example 6.** Claisen-Schmidt Reaction: Aldehyde + Ketone

> ⑧ **Example 7.** Mukaiyama Aldol Reaction

>> ○ 1-methylcyclohexanone + (CH<sub>3</sub>)<sub>3</sub>SiCl, (CH<sub>3</sub>CH<sub>2</sub>)<sub>3</sub>N → Thermodynamic silyl ether predominant
...
>> ○ Base is neutralized with NaOEt to prevent additional reactions.
...
**Figure 28.** Ester Transesterification
...
>>> ○ Dehydrogenation of α-carbonyl hydrogen by NaOEt prefers ethyl butanoate, present in small amounts during the reaction.

>>> ○ Dehydrogenated ethyl butanoate reacts with the excess other ester.

>>> ○ Without a small amount of ethyl butanoate, a simple Claisen condensation reaction can occur.
...
>> ○ **Point 2:** The base must have the same form as the OR group of the ester (**∵** Ester exchange reaction)
...
>> ○ **Point 3:** In the case of crossed Claisen condensation, the reaction must be composed between benzoate and non-benzoate
...
>>> ○ When reactions are composed like ethyl propanoate + ethyl ethanoate, significant crossed Claisen reactions also occur
...
> ① Definition: Cyclization reaction between vinyl ketone and ketone

> ② **(Formula)** Vinyl beta carbon forms a ring through a double bond cleavage reaction, and the other beta carbon loses an oxygen from a different ketone oxygen and forms a bond
...
>> ○ For Malonic Ester, a reaction is needed to convert it to Malonic Acid under acidic or basic catalytic conditions.
...
> ① 1,4 Addition Reaction to Enolates

> ② Includes Enolate-Ketone Tautomerization Process
...
> ② Enamines react with alkyl halides, acyl halides, carbonyl compounds, and more as nucleophiles.

> ③ **Step 1.** [Ketone Amination Reaction](https://www.scripps.edu/baran/images/grpmtgpdf/Lockner_Nov_07.pdf)

>> ○ Reaction differences based on the amine

>>> ○ Bulky amines (pK<sub>a</sub> = 6-10, e.g., pyrrolidine): Reaction proceeds without acid catalysis. Dehydration is rate-determining.

>>> ○ Less bulky amines (pK<sub>a</sub> = 3-5, e.g., Ph-NH-Me): Acid catalysis is required for the reaction and dehydration.

>>> ○ Acid catalyst: Strong acidic catalysts like p-TsOH are commonly used.

>> ○ Yield enhancement strategy: Water (H<sub>2</sub>O) is generated as a result of the main reaction, so its removal increases the yield.
