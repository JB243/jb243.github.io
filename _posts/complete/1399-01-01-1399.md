...
> ② Weight-average molecular weight (M<sub>w</sub>): Related to viscosity, tensile strength, refractive index, etc.
...
>> ○ For chloroform solutions of PLA (25°C): K = 5.45 × 10<sup>-4</sup>, α = 0.73
...
>> ○ If 0 < PDI < 0.2, nanodispersion is excellent
...
> ② Measurement methods: X-ray diffraction, infrared spectroscopy, differential scanning calorimetry (measurement of melting heat change)
...
>> ○ Polystyrene has preferred direction in polymerization for maximizing resonance stabilization
