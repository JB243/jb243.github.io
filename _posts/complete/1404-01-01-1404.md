...
> ② **Focus on <sup>1</sup>H NMR**: It's recommended to solve problems primarily using 1H NMR, as it can be approached like solving a math problem and provides a substantial amount of information.
...
> ⑥ **Chemical Shifts of Hydrogens on the Same Carbon**: Hydrogens attached to the same carbon can have different chemical shift values (ppm) in 1H NMR depending on their spatial arrangement.
