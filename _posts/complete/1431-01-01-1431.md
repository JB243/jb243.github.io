...
>> ○ The ~10.5 bp periodicity observed in ATAC-seq is related to the fact that one full turn of the DNA helix requires 10 bp, which is associated with the minor groove distance.
