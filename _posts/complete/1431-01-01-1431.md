...
**Table 1.** CUT&Tag vs. CUT&RUN vs. ChIP-Seq 
...
> ⑥ **Type 5.** DNaseI-seq: Can identify the types of transcription factors interacting with chromatin.  
...
**Figure 6.** Comparison of ATAC-seq with Various Sequencing Techniques
