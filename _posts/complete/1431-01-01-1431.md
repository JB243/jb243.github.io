...
> ① Definition: Analyzes DNA regions bound to specific proteins like transcription factors

> ② Combines DNA sequencing with ChIP (chromatin immunoprecipitation) to determine DNA-associated protein binding sites

> ③ 1<sup>st</sup>. Proteins (e.g., transcription factors) are cross-linked to DNA

> ④ 2<sup>nd</sup>. DNA is fragmented by sonication: Cross-linked DNA remains intact

> ⑤ 3<sup>rd</sup>. Add antibody-bound beads to immunoprecipitate specific proteins and their associated DNA

> ⑥ 4<sup>th</sup>. Separate DNA from the precipitate and sequence it to determine the nucleotide sequence

> ⑦ Finally, identify binding sites of proteins like transcription factors
