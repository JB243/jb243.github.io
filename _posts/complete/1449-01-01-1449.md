...
> ⑥ (Note) Antennapedia complex(_lab_, _pb_, _dfd_, _scr_, _Antp_) = Head region(_lab_, _dfd_, _pb_) + thoracic segments(_scr_, _Antp_) 

> ⑦ (Note) bithorax complex(_Ubx_, _abdA_, _abdB_) = Thoracic segments(_Ubx_) + abdominal segments(_abdA_, _abdB_)
