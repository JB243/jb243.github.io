...
> ② Accurately combusts the sample under O<sub>2</sub> to ionize constituent elements (C, H, N, S, O)
...
> ⑤ Measures the amount of CO<sub>2</sub> generated after thermal decomposition without oxygen, followed by separation of other generated gases using an adsorption trap

> ⑥ Ultimately measures the composition of gases under helium using GC chromatography
...
> ① Definition: A method of separating vaporized sample components between a stationary phase and a moving gas phase in a separation column

> ② Inert gases like helium, hydrogen, nitrogen, argon are commonly used as carrier gases
...
> ⑥ **Application 2:** Measuring molecular weights through gas chromatography: using retention time and molecular weight correlation

> ⑦ **Application 3:** Gas Chromatography Mass Spectrography (GC-MS)

>> ○ 1<sup>st</sup> Step: Separated substances from gas chromatography are ionized or chemically ionized for mass-dependent classification
