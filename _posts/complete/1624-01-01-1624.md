...
<img width="289" height="119" alt="스크린샷 2025-09-12 오후 3 41 30" src="https://github.com/user-attachments/assets/109dd11e-ce54-488c-b8c7-9f851a71105c" />
...
⑷ [Isserlis's theorem](https://en.wikipedia.org/wiki/Isserlis%27s_theorem)

> ① Isserlis's theorem: Random variables (Probability theory, Statistics)

>> ○ States that higher-order moments of a multivariate normal distribution can be expressed in terms of covariances.

>> ○ **Case 1.** Odd-order moments: 0

<br>

<img width="316" height="32" alt="스크린샷 2025-10-02 오후 3 45 16" src="https://github.com/user-attachments/assets/fd3b55a9-0c5c-44d2-9c9f-c05138ff9623" />

<br>

>> ○ **Case 2.** Even-order moments: can be expressed as products of covariances by pairing variables two at a time.

<br>

<img width="268" height="179" alt="스크린샷 2025-10-02 오후 3 45 42" src="https://github.com/user-attachments/assets/8559fbd0-f58a-4c2d-8560-d2537c36d6f6" />

<br>

>> ○ The mean must be zero for the formula to take the neat form above, but the variances do not need to be equal.

> ② Wick's theorem: Quantum fields (Physics, QFT)

>> ○ Application of the same mathematics as Isserlis's theorem, but in the context of quantum field theory.

>> ○ **Example:** The n-point function of a Gaussian free field can be decomposed into products of two-point functions.
