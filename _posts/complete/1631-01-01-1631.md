...
> ⑦ **4-6.** McNemar's test: One-sample 

> ⑧ **4-7.** [Kolmogorov-Smirnov two-sample test](https://jb243.github.io/pages/2310#4-kolmogorov-smirnov-two-sample-test): Two-sample. Non-parametric

> ⑨ **4-8.** Simulation: Monte Carlo simulation (e.g., Permutation), Bootstrap
...
> ⑤ **5-4.** [Friedman test](https://jb243.github.io/pages/1688#3-friedman-test): Repeated measures 

> ⑥ **5-5.** Cochrane Q: Repeated measures

> ⑦ **5-6.** [Two-way ANOVA](https://jb243.github.io/pages/1635#3-two-way-anova)
