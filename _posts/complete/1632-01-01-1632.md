...
>> ○ (note) [Engression](https://arxiv.org/pdf/2307.00835): While general regression assumes Y = g(X) ± ε, engression instead models Y = g(X + ε), which makes extrapolation possible (where ε is noise).
