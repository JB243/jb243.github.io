...
|         | 1       | 2       | ...     | S       | Total  |
|---------|---------|---------|---------|---------|--------|
| X<sup>(1)</sup> | N<sub>1</sub><sup>(1)</sup> | N<sub>2</sub><sup>(1)</sup> | \cdots | N<sub>S</sub><sup>(1)</sup> | n<sup>(1)</sup> |
| X<sup>(2)</sup> | N<sub>1</sub><sup>(2)</sup> | N<sub>2</sub><sup>(2)</sup> | \cdots | N<sub>S</sub><sup>(2)</sup> | n<sup>(2)</sup> |
| \vdots | \vdots | \vdots | \ddots | \vdots | \vdots |
| X<sup>(K)</sup> | N<sub>1</sub><sup>(K)</sup> | N<sub>2</sub><sup>(K)</sup> | \cdots | N<sub>S</sub><sup>(K)</sup> | n<sup>(K)</sup> |
|         | m<sub>1</sub> | m<sub>2</sub> | \cdots | m<sub>S</sub> | n |
