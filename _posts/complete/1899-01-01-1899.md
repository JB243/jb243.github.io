...
> ⑪ **Use 11.** Three points are collinear if and only if the determinant of the matrix formed by their coordinate vectors is zero.

>> ○ Example: [Proof of Desargues’ Theorem](https://nate9389.tistory.com/286)
...
> ⑥ **Theorem 1.** Calculation of det($A$ + $B$) given an arbitrary matrix $A$ and a matrix $B$ with rank 1

<br>

<img width="547" height="481" alt="스크린샷 2026-09-04 오후 1 57 59" src="https://github.com/user-attachments/assets/06a9c413-be12-4054-810a-8e19a099f4f2" />

<br>

⑷ **Computing inverses 2.** Adjoint matrix (Adjugate matrix)

> ① Minor: When A is an $n$ × $n$ matrix, removing row i and column j results in an $(n-1)$ × $(n-1)$ matrix.
...
<img width="206" height="353" alt="스크린샷 2026-09-04 오후 2 04 19" src="https://github.com/user-attachments/assets/94851e3c-468c-4f64-bae1-732b0ab08126" />
