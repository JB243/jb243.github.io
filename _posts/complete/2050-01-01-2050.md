...
**11.** [**Common 5.** Cell Type Mapping Analysis](#11-cell-type-mapping-analysis)

**12.** [**Advanced 1.** Alternative Splicing Analysis (AS Analysis)](#12-advanced-1-alternative-splicing-analysis-as-analysis)

**13.** [**Advanced 2.** Epigenomics Analysis](#13-advanced-2-epigenomics-analysis)

**14.** [**Advanced 3.** Special Transcriptpmics Analysis](#14-advanced-3-special-transcriptomics-analysis)

**15.** [**Advanced 4.** Database Utilization](#15-advanced-4-database-utilization)
...
![image](https://github.com/JB243/jb243.github.io/assets/55747737/c880da45-b830-4048-8a72-ed8286f5a779)
...
![image](https://github.com/JB243/jb243.github.io/assets/55747737/9ac8f75a-a63b-41c3-9048-82de8599d001)
...
![image](https://github.com/JB243/jb243.github.io/assets/55747737/4453f652-65ba-438e-9a51-2d468a2f8192)
...
![image](https://github.com/JB243/jb243.github.io/assets/55747737/fbd411da-f03f-415f-bc7e-541c474dad35)
...
> ① **2-1.** **assembly** **:** The process of reconstructing partial DNA/RNA fragments obtained due to technical limitations back into their original transcripts.([ref](https://biology.stackexchange.com/questions/40436/what-is-the-difference-between-sequence-alignment-and-sequence-assembly))

<br>

![image](https://github.com/JB243/jb243.github.io/assets/55747737/8a901242-a96e-4f90-b5ed-cd31f5a4d1f8)
...
>>> ○ **1-1.** [STAR](https://github.com/alexdobin/STAR): Most commonly used alignment tool. ([ref](https://hbctraining.github.io/Intro-to-rnaseq-hpc-O2/lessons/03_alignment.html))
...
>>> ○ **1-2.** [Hisat2](https://ccb.jhu.edu/software/hisat2/index.shtml): Implemented the GFM (graph FM index) based on graph's BWT extension, the first of its kind.

>>> ○ **1-3.** Bowtie, [Bowtie2](https://bowtie-bio.sourceforge.net/bowtie2/index.shtml)
...
>>> ○ **2-1.** Kallisto: [paper](https://www.nature.com/articles/nbt.3519), [manual](http://pachterlab.github.io/kallisto/manual.html)

>>> ○ **2-2.** Sleuth: [blogpost](https://liorpachter.wordpress.com/2015/08/17/a-sleuth-for-rna-seq/), [tutorial](https://rawgit.com/pachterlab/sleuth/master/inst/doc/intro.html)

>>> ○ **2-3.** Salmon: [preprint](https://www.biorxiv.org/content/10.1101/021592v1), [manual](https://salmon.readthedocs.io/en/latest/salmon.html)

>> ○ **Type 3.** Alignment and counting for scRNA-seq

>>> ○ **3-1.** [CellRanger](https://support.10xgenomics.com/single-cell-gene-expression/software/pipelines/latest/what-is-cell-ranger): Uses STAR alignment.

>> ○ **Type 4.** Alignment and counting for ST data

>>> ○ **4-1.** [SpaceRanger](https://www.10xgenomics.com/support/software/space-ranger/downloads): Limited to Visium. Uses STAR alignment but considers spatial barcoding.

>>> ○ **4-2.** [SpaceMake](https://academic.oup.com/gigascience/article/doi/10.1093/gigascience/giac064/6646447) : Integrated workflow to process various spatial transcriptomics data.

>> ○ **Type 5.** **splice-aware aligner**: Aligner that considers RNA-specific events like splicing during alignment.

> ② **2-2.** **reference matching:** Process of determining which reference a read comes from when using multiple references of different species. Narrow definition of alignment. ([ref](https://biology.stackexchange.com/questions/40436/what-is-the-difference-between-sequence-alignment-and-sequence-assembly))

![image](https://github.com/JB243/jb243.github.io/assets/55747737/45933ee9-6120-43db-9335-004b62fa807c)
...
![image](https://github.com/JB243/jb243.github.io/assets/55747737/ce93bf72-530a-4e85-9c29-eb511d070d2f)
...
> ⑦ **Type 6:** [Hisat2](https://ccb.jhu.edu/software/hisat2/index.shtml) **:**
genome-based

> ⑧ **Type 7:** [eXpress](https://pachterlab.github.io/eXpress/index.html) **:**
transcriptome-based

> ⑨ **Type 8:** [bowtie2](http://bowtie-bio.sourceforge.net/bowtie2/index.shtml)
**:** transcriptome-based
...
>> ○ [CellRanger](https://support.10xgenomics.com/single-cell-gene-
expression/software/pipelines/latest/what-is-cell-ranger)

> ⑬ **Type 12:** ST alignment and count

>> ○ [SpaceRanger](https://www.10xgenomics.com/support/software/space-
ranger/downloads) **:** Limited to Visium. Uses STAR alignment and considers spatial barcoding additionally
...
⑼ **Step 8.** ( _optional_ ) **Variant calling** **:** Can investigate genetic variations like SNPs or indels
...
⑽ **Step 9.** ( _optional_ ) **_Post-hoc_ ** **transcript-to-gene conversion**
**:** When having count data for transcript IDs, it might be necessary to collapse multiple transcript IDs into one gene ID (e.g., for GO analysis)
...
>> ○ **Method** **3.** [Ensembl](http://asia.ensembl.org/info/data/ftp/index.html)
**:**
[manual](https://jb243.github.io/pages/2156#:~:text=ensembl_gene_id%EC%99%80%20gene_symbol%20%EA%B0%84%EC%9D%98%20%EB%B3%80%ED%99%98%20%EB%93%B1)
...
![image](https://github.com/JB243/jb243.github.io/assets/55747737/732a5500-07e5-4f0c-9bca-3792cca86d5c)
...
![image](https://github.com/JB243/jb243.github.io/assets/55747737/a56221af-ccaf-4b1b-870a-e478ffbcdd44)

>>> ○ The following depicts differential gene expression of gene g between Sample 1 and Sample 2

![image](https://github.com/JB243/jb243.github.io/assets/55747737/a7b8e8a3-0161-4032-878a-e3723dd537e8)
...
![image](https://github.com/JB243/jb243.github.io/assets/55747737/26ab4c4f-66e1-4012-9537-134e67468ff8)
...
![image](https://github.com/JB243/jb243.github.io/assets/55747737/dd9b8488-2213-4454-a848-628dc4c1cbdd)

>>> ○ M<sub>g</sub> **:** Gene-wise log-fold-change

![image](https://github.com/JB243/jb243.github.io/assets/55747737/d21535fa-d0df-42b9-82e0-cc8bbeb4cee3)

>>> ○ A<sub>g</sub> **:** Absolute expression level

>>> ○ S<sub>k</sub> / S<sub>r</sub> **:** Scaling factor to divide by in sample k. Proportional to Sk (See **Idea 1**)

>>> ○ TMM **:** Normalization factor

>> ○ 2<sup>nd</sup>. Remove genes with expression of 0

>> ○ 3<sup>rd</sup>. Trimming
...
![image](https://github.com/JB243/jb243.github.io/assets/55747737/225f2013-fb04-4896-93ed-b692dcc734a3)
...
![image](https://github.com/JB243/jb243.github.io/assets/55747737/5d3028c1-f9d6-4922-8667-e9c3defb355e)
...
![image](https://github.com/JB243/jb243.github.io/assets/55747737/16532e2c-1fdc-4ecd-aa6e-b33a4bfbbcf1)
...
![image](https://github.com/JB243/jb243.github.io/assets/55747737/c469eeed-edb2-42f9-b77e-88c2ff102a3b)

>> ○ Relation between TPM and RPKM: For the number of genes n,

![image](https://github.com/JB243/jb243.github.io/assets/55747737/30ddb47e-9eb6-4df3-b8bf-aa0233041f96)
...
![image](https://github.com/JB243/jb243.github.io/assets/55747737/e68ae2a3-353c-41fa-a7d9-ac780cd8a868)
...
> ⑥ **Method 4.** [BBKNN](https://github.com/Teichlab/bbknn) (Batch-Balanced k-Nearest Neighbor)

> ⑦ **Method 5.** [Scanorama](https://www.nature.com/articles/s41587-019-0113-3) **:** Used in Python scanorama.
...
> ⑪ **Method 9.** [FastMNN](https://bioconductor.org/packages/batchelor/) (batchelor)

> ⑫ **Method 10.** [Harmony](https://github.com/immunogenomics/harmony) 

> ⑬ **Method 11.** [LIGER](https://github.com/MacoskoLab/liger) **:** A general approach for integrating single-cell transcriptomic, epigenomic and spatial transcriptomic data. factor-based
...
![image](https://github.com/JB243/jb243.github.io/assets/55747737/72103c4a-9bbe-42c9-b36d-915636ce20c6)
...
>> ○ limma FPKM ([paper](https://support.bioconductor.org/p/56275/), [manual](https://www.biocon
...
![image](https://github.com/JB243/jb243.github.io/assets/55747737/f2e50b10-339b-4813-baa8-d2aa0aa4ba99)
...
![image](https://github.com/JB243/jb243.github.io/assets/55747737/4bdc389f-57d1-45b4-bc64-8f910700c088)
...
![image](https://github.com/JB243/jb243.github.io/assets/55747737/1e57f347-f6a7-466f-ac8a-285a6f827e1e)
...
>> ○ [Simple use of GPT-4](https://www.nature.com/articles/s41592-024-02235-4?fbclid=IwAR1v-I9ax-44NtsrNrlf7UxRaVCZrSe1LOzykOStZY4-RBlnFbfD-2jqXlw_aem_AUbIEUfFx21RQN4K1IAKF3qlboOatFmNvov6it3MUsqdQeDFd1ncuiL2pXDwff665_U)
...
> ⑤ [celltypist](https://github.com/Teichlab/celltypist) and [celltypist2](https://github.com/Teichlab/celltypist): Python-based, with the following list of references:
...
![image](https://github.com/JB243/jb243.github.io/assets/55747737/a6f9beb1-f237-4778-9471-fc014336eaa3)
...
>> ○ Recently, Nanostring has survived dramatically in patent disputes with 10x ([ref](https://www.businesswire.com/news/home/20230711643008/en/Delaware-District-Court-Permits-NanoString%E2%80%99s-Counterclaims-that-10x-Genomics-and-Harvard-Violated-the-Antitrust-Laws))
...
>> ○ Comprehensive pipeline **:** [SpatialData](https://www.nature.com/articles/s41592-024-02212-x) 

<br>

![image](https://github.com/JB243/jb243.github.io/assets/55747737/6ede1aaf-a5e4-4c74-abfc-4297b57a1db0)

**Figure. 9.** ST analysis downstream pipeline

<br>

> ④ 3D spatial transcriptomics ([ref1](https://www.science.org/doi/10.1126/sciadv.abb3446?url_ver=Z39.88-2003&rfr_id=ori:rid:crossref.org&rfr_dat=cr_pub%20%200pubmed), [ref2](https://www.biorxiv.org/content/10.1101/2023.03.06.531348v1.full), [ref3](https://www.biorxiv.org/content/10.1101/2023.07.21.550124v1))
...
⑺ [Natural Language Models](https://jb243.github.io/pages/325)
