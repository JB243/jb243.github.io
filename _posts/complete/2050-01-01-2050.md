...
>> ○ [scGPT](https://www.nature.com/articles/s41592-024-02201-0): Used as GPT → pretraining → finetuning. The zero-shot performance of the pretraining model is also quite excellent.

>> ○ [GeneFormer](https://huggingface.co/ctheodoris/Geneformer): Used as BERT → pretraining → finetuning. The zero-shot capability is practically useless.
