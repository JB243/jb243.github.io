...
![image](https://github.com/JB243/jb243.github.io/assets/55747737/5aefa6d9-b0f0-44dd-861b-9550ed9fa78d)
...
⑽ **Step 9.** ( _optional_ ) **_Post-hoc_ ** **transcript-to-gene conversion**: When having count data for transcript IDs, it might be necessary to collapse multiple transcript IDs into one gene ID (e.g., for GO analysis)
...
>> ○ This functionality is relatively new in Python, so it has been used quite frequently in these days.
...
>> ○ Provides normalized expressions that remove batch effects and provides code to calculate DEGs based on them.
