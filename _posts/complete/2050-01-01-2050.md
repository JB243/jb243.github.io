...
> ① **2-1.** **assembly**: The process of finding the corresponding reference genome positions for short DNA/RNA fragments obtained partially due to technical limitations. ([ref](https://biology.stackexchange.com/questions/40436/what-is-the-difference-between-sequence-alignment-and-sequence-assembly))
...
>>> ○ Information such as position and mismatches are considered.

>>> ○ Quaternary numbers, hash functions, sliding window, and minimizers are used.

>>> ○ Assembly graph is used.
