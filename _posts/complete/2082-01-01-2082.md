...
> > ○ Abelian group(Abelian group): Group + commutativity a*b = b*a

> > ○ Product group(product group): Defined as the Cartesian product G × H of two groups G, H (e.g., (g<sub>1</sub>, h<sub>1</sub>))

> > > ○ The new group operation is (g<sub>1</sub>, h<sub>1</sub>)·(g<sub>2</sub>, h<sub>2</sub>) = (g<sub>1</sub>g<sub>2</sub>, h<sub>1</sub>h<sub>2</sub>)
...
> ⑪ [Vector space](https://jb243.github.io/pages/1897#2-vector-space): A module whose scalar ring is a field; i.e., a module over a field

> ⑫ Homogeneous space(homogeneous space): A space X such that for any pair x<sub>1</sub>, x<sub>2</sub> ∈ X, there always exists g ∈ G with gx<sub>1</sub> = x<sub>2</sub>
...
⑵ [Nature does not favor either x or y over the other.](https://jb243.github.io/pages/2307)
...
⑷ [Any matrix B that commutes with a diagonalizable matrix A can be represented in block-diagonal form, with each block corresponding to an eigenvalue.](https://jb243.github.io/pages/2307)
