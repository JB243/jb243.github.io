...
**Figure 5.** DBSCAN Python example
 ...
 **Figure 7.** Comparison of K means clustering and Gaussian mixture model
...
**Figure 8.** Region-oriented segmentation (Note that T = 3 means the cutoff of the difference in values)
...
**Figure 9.** region splitting and merging
