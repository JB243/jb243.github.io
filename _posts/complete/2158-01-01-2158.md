...
> ① A<sup>T</sup>A = V(∑<sup>T</sup>∑)V<sup>T</sup> : The singular values of A are the square roots of the eigenvalues of A<sup>T</sup>A. However, some eigenvalues are set to 0 according to the rank.

> ② Frobenius norm

<br>

<img width="175" alt="스크린샷 2024-10-22 오전 11 50 55" src="https://github.com/user-attachments/assets/d1d715fc-9156-4b31-8796-8295a9187274">
