...
> ① An algorithm that assumes conditional independence of variables in the data, combines prior information about classes with information extracted from data, and classifies data into specific classes using Bayes' theorem

> ② Can be used as a solution for problems that involve classifying documents into categories such as spam, economics, sports, etc., in text classification
