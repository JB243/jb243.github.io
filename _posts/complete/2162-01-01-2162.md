...
> ② Formula: note that δ<sub>k</sub><sup>2</sup> is always non-negative.
...
> ③ With a fixed policy and on-policy sampling, convergence is guaranteed (in an appropriate sense).
...
> ④ If those conditions are violated (e.g., off-policy learning or updating with incorrect weighting), the algorithm can diverge.
...
<img width="391" height="87" alt="스크린샷 2026-02-12 오전 9 38 23" src="https://github.com/user-attachments/assets/1426f45d-182d-49eb-a3b3-d0972d8288fb" />
