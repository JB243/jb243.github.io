...
>> ○ **Characteristics 1.** In Q-learning, states can be continuous, but actions must be discrete

>> ○ **Characteristics 2.** In policy gradient, both states and actions can be continuous
