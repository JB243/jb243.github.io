...
> ○ Database: GO, MSigDB, HALLMARK, PROGENy, KEGG, Reactome, [clue.io](https://clue.io/command?q=/gene-space%20Im), etc.
...
>> ○ Although it's technically a location label and not a function _per se_, it often provides important clues about the protein's role.
...
>> ○ TYMS, ATAD2, RRM2, KIAA0101, TK1, PCNA, DNMT1, UBE2T, DUT, DHFR, TUBB, CENPM, RAD51, AP1, ZWINT, RNASEH2A, TMEM106C, HMGB2, TUBA1B, HIST1H4C, HELLS, CLSPN, FEN1, NUSAP1, STRA13, CDK1, RFC4, RRM1, DNAJC9, WDR34, STMN1, USP1, CENPU, ASF1B, GMNN, SLBP, FAM111B, CENPK, PHGDH, PSMC3IP, CHAF1A, RFC2, WDR76, CDK4, RPA2, GGCT, MCM7, CDC6, MCM3, EZH2, PSIP1, SPC25, NASP, TMPO, TUBG1, TEX30, PKMYT1, SIVA1, MTHFD2 ([ref](https://www-nature-com.proxy.lib.umich.edu/articles/s41588-023-01357-3#Sec46))
...
> ○ `Autism spectrum disorder (ASD) risk gene`: PTEN, CYLD

> ○ `Cancer stemness`: ALDH1A1, ALDH1A3, SOX2, KLF4, PROM1, EPCAM, KRT19, ITGA6

> ○ `Cancer dormancy`: HES1, ID1, ID2, ID3, NR2F1, CDKN1A, CDKN1B, BTG1, BTG2, TOB1 
...
> ○ `Proliferation genes`: MKI67, MCM2, PCNA, STMN1, Mki67, Mpp1, Aurkb, Top2a, HMMR, UBE2C, CDK1

> ○ `Immunosuppression`: APOE, GPNMB 

> ○ `E2F targets`: ATAD2, MCM2, BIRC5

> ○ `Differentiation`: TFF3, CDKN2D

> ○ `Neuron differentiation`: STMN2, STMN4, TUBB3
...
> ○ `Cell apoptosis`: FOXO3, MCL1, Pmaip1, Bax, Bbc3
...
> ○ `Innate immunity`: UBASH3B, DNASE2, FAM135A

> ○ `Autophagy`: NPEPPS, VMP1, ULK1, RICTOR
...
> ○ `Mitochondrial ribosomes`: TUFM, MPC1, NDUF
...
> ○ `Alveolar surfactant`: SFTPA1, SFTPA2, SFTPB, SFTPC
...
> ○ `oncofetal signature`: PLVAP, POSTN, FOLR2, GPC3, AFP
...
> ○ `Extracellular matrix`: FBLN, COL1A2, COL3A1, BGN, COL1A1, COL1A2, SPP1, FN1, TIMP1, COL6A2, LYPD3, SLPI, MT2A, NIME2, IFITM3, DCN, TNC, ITGA4, FGF1, COL4A6, LTBP1, LTBP2
...
> ○ `Stem-related genes`: SOX4, CD164, SOX9, RNF43, STAT6
...
> ○ `DNA damage`: DNAJB1, HSPH1, RAD50, MTREX, IFI16, SAMHD1, CBL, APC

> ○ `DNA damage repair`: APE1, OGG1, UNG, MACROD1, ABRAXAS2, BCCIP, RFC1, RAD17, TP53, ATM

> ○ `Somatic mutation burden`: ETFB, COQ10A, GFER , MDH2, SCO2, IDH3B, COX4I1

> ○ `TGFβ signaling pathway`: TGFB2, TGFB3, BMP6

> ○ `JAK–STAT signaling pathway`: IL1B, IL6, IL10

> ○ `Chemokines`: CCL2, CCL4, CCL8, CCL7, CXCL1, CXCL10, CXCL2, CXCL3
...
> ○ `Wnt/β-catenin signaling`: CTNNB1, GSK3B, TCF12, AXIN1, APC

> ○ `Notch signaling`: Ep300, Fbxw7, Maml1, Notch1, Notch2, Notch3, Notch4, Rbpj, Dll1, Dll4, Jag1, Jag2

> ○ `EGFR signaling`: EGFR, ERBB4, JAK1, STAT3

> ○ `Hippo signaling`: YAP1, STK3, DLG1, DLG2

> ○ `Ras/MAPK signaling`: SOS1, SOS2, MAP3K20, MAP4K4, MAPK8

> ○ `Tumor suppressor gene`: TP53, DCC, ZNF292, HMGN3, UBE2J1, NR4A3, DHRS7C, CREBZF, ARHGAP6

> ○ `Senescence`: SLPI, SPRR1B, SPRR3, IL1RN, LCN2, C15orf48, SPRR2A, S100A8, S100A9, CXCL17, MALL, SPRR2D, KRT13, PRSS22, RHCG, ANXA1, ERO1A, PDZK1IP1, S100P, CEACAM5, TMPRSS11D, SPRR1A, PVRL4, KRT16, EMP1, RAB11FIP1, LMO7, NDRG2, SPRR2E, SERPINB1, KRT6A, CD24, C19orf33, PSCA, CEACAM6, CLDN4, CLDN7, SDCBP2, MUC4, MXD1, LYPD3, KRT6B, LY6D, CLIC3, GPRC5A, TSPAN1, PRSS8, SRD5A3, CD55, CSTB, LYNX1, APOBEC3A, S100A7, RDH10, MUC1, TMPRSS11E, CDKN1A (p21), PI3, DSC2, NCCRP1, CEACAM1, SAT1, DUSP5, LIPH, CSTA, TMEM40 ([ref](https://www-nature-com.proxy.lib.umich.edu/articles/s41588-023-01357-3#Sec46)), CDKN2A (p16)

>> ○ `Senescent inflammatory`: CDKN2B, CDKN2A, ANXA1
...
> ○ `EMT signature`: LAMC2, PLAU, TNFRSF12A, EMP3, S100A2, LAMB3, PTHLH, TGFBI, PHLDA1, NDRG1, LAMA3, ITGA6, ITGA3, IGFBP7, KRT17, CDH3, P4HA2, TPM1, ARPC1B, PDPN, ACTN1, CTSB ([ref](https://www-nature-com.proxy.lib.umich.edu/articles/s41588-023-01357-3#Sec46)), FN1, TWIST1, SNAI1, SNAI2, ZEB1, TGFB1, TGFB2, CTNNB1, SPON2
...
> ○ `Zinc finger`: ZNF44, ZNF8 3, ZNF138, ZNF148

> ○ `Ubiquitin`: ABLIM1, MIB1, RNF19A, FBXL17, FBXO42, ANAPC1, SEL1L, ANAPC1, UBE4A, USP25, USP33, UBXN7, UBE2H, UBE2K, CUL1 , CUL3, PIAS1 , HUWE1, CDC27, USP24, CBL, SHPRH, RNF216, KLHDC10, PTPRO

> ○ `F-box proteins`: FBXL17, FBXO42

> ○ `Chromatin Modification`: ASXL1, SETD2

> ○ `RNA splicing`: SF3B1

> ○ `neutrophil effector`: ELANE, CTSG, PRTN3, CD177

> ○ `antimicrobial peptide`: CAMP, DEFB3, S100A8, S100A9

> ○ `matrix metalloproteinase`: MMP8, MMP9

> ○ `NADPH oxidase complex`: NCF1, NCF2, NCF4, CYBA, CYBB

> ○ `leukotriene biosynthetic enzyme`: ALOX5, ALOX5AP, PLA2G4B, PLA2G4D, PLA2G4E

> ○ `sterol synthesis machinery`: HMGCS1, MVD, FDPS, FDFT1, SQLE, LSS, CYP51A1, SC5D, HSD17B7, MSMO1, PMVK

> ○ `sphingolipid biosynthesis enzyme`: SPTLC1, SPTLC2, DEGS1, CERS3

> ○ `prostate cancer hypermethylation marker`: ASC1, APC, GSTP1, RARB2, RASSF1A ([ref](https://pmc.ncbi.nlm.nih.gov/articles/PMC2409889/))
