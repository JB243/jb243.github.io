...
>> ○ Shutdown-related: USCIS is a fee-funded agency, so it will continue its core operations—such as application intake, adjudications, biometrics, and interviews—even during a federal government shutdown. However, delays or suspensions may occur in stages that depend on other agencies (e.g., DOL, E-Verify, overseas visa issuance, etc.).
...
> ③ **Type 2.** [EB-1](https://www.koreadaily.com/article/20260119193751658) (Einstein visa): International Ph.D. students in US can also apply for this.

> ④ **Type 3.** EB-2 National Interest Waiver (NIW)

>> ○ The EB-2 National Interest Waiver (NIW) has less stringent qualification requirements compared to the top-tier EB-1.

>> ○ EB-2 requires either a master’s degree or a bachelor’s degree accompanied by a major award of high distinction.
...
>>> ○ However, if a permanent resident stays abroad for more than six months and wants to return, they must apply for an I-131 re-entry permit, obtain the two-year re-entry permit, and present it upon entry. ([ref](https://www.youtube.com/watch?v=N7E60FNEJMY))
...
>> ○ **Example 3:** In the case of graduating from a U.S. college or graduate school and serving in the U.S. military. One needs a green card to enlist in the U.S. military.
...
>> ○ Close unused bank accounts via mobile app or website
...
> ○ If there is a J1 spouse, they are guaranteed the opportunity to legally study or work in the U.S.
