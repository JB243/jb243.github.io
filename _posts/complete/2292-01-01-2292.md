...
#### **42. TypeError: can't multiply sequence by non-int of type 'float'**
 ...
 ⑴ **Problem Situation:** Attempting to multiply a float value in a situation where only integers can be multiplied.
...
```
 ...
 ⑵ [Reference](https://www.freecodecamp.org/news/typeerror-cant-multiply-sequence-by-non-int-of-type-float-solved/)
