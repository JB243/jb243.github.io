...
![image](https://github.com/JB243/jb243.github.io/assets/55747737/2808f435-263a-46bc-80d3-a0ce47cb34b3)
...
>> ○ US phone numbers can be obtained after moving to the US, so it's recommended to borrow one from a friend: they will understand

>> ○ A phone number is required for account registration or direct calls

>> ○ International calls can also be made using WeChat, WhatsApp, Free International Call app, Text Plus app, etc.
...
⑴ Some people attend English academies separately to adapt to the local environment

⑵ In the UK, receipts and train tickets look the same

⑶ Driver's license

> ① International driver's licenses can be used as identification

> ② For practical reasons, you may need to obtain a local driver's license

⑷ Mobile

> ① Termination of domestic telecommunication services and activation of [MVNO](https://www.epost.go.kr/comm.alddlord.RetrieveChargeList.comm?phonepaydivcd=N) (mobile virtual network operator)

> ② [Useful Websites for Mobile Plans](https://www.mintmobile.com/deals/)
