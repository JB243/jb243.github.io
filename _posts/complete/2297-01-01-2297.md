...
> ② Secretary of State (SOS): It is recommended to make an appointment for your visit, e.g. registration can be [here](https://dsvsesvc.sos.state.mi.us/TAP/_/) for Michigan.

> ③ Required documents: Passport (+ Visa), I-94, I-20, Korean driver's license, International driver's permit, Proof of residence, SSN or ineligibility letter, $25 fee.

>> ○ If you have an international driver's license, you don't need to take the test (written test and road test).

>> ○ Proof of residence: utility bill, bank statements, rental agreements, college transcripts, …
...
> ⑥ If you already have a Korean driver's license, you can obtain a U.S. driver's license without taking an additional test.

> ⑦ The ineligibility letter must be issued by the Social Security Administration ([ref](https://internationalcenter.umich.edu/resources/tax/applying-ssn-card)): Passport and home address are required.
