...
⑷ [SSN](https://internationalcenter.umich.edu/resources/ssn/applying-ssn-card) (Social Security Number)

> ① Overview

>> ○ Even F-1 visa students can obtain an SSN if they are employed (e.g., RA, TA).

>> ○ If the stipend is categorized as a fellowship, an SSN cannot be issued.
...
>> ○ **Step 2.** Receive employment verification documents from the International Center (PI signature required).

>> ○ **Step 3.** Make an appointment with the Social Security Administration: must be within 45 days of the application date.

>> ○ **Step 4.** Prepare documents such as passport, driver’s license, I-94, I-20, etc.

>> ○ **Step 5.** The SSN will be mailed within 2 weeks from the appointment date.
...
<img width="526" height="429" alt="스크린샷 2025-09-13 오후 6 19 59" src="https://github.com/user-attachments/assets/02306217-7a83-475c-a4e7-3bbd52e187f6" />
