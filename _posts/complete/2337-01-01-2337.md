...
> ④ **Method 2.** Use [FastQC](https://www.bioinformatics.babraham.ac.uk/projects/download.html#fastqc) program

> ⑤ **Method 3.** Use [conda Fastqc](https://anaconda.org/bioconda/fastqc) command (Linux)

> ⑥ **Method 4.** Download [SRA](https://github.com/ncbi/sra-tools/wiki/01.-Downloading-SRA-Toolkit) (Sequence Reads Archive) Toolkit and use fastqc command (Linux) **:** Below is an example of generated files
