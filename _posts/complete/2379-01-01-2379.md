...
**Review.** The number of possible correct answers is $\binom{2n}{n} = \binom{6}{3} = 20$, and with three weighings on a balance scale, the number of possible outcomes is $3^n = 3^3 = 27$. Therefore, from an information-theoretic perspective, three weighings are the lower bound. In other words, the general lower bound is as follows.

<br>

<img width="103" height="46" alt="스크린샷 2026-05-06 오전 12 07 34" src="https://github.com/user-attachments/assets/347b35e5-4963-4260-826f-3659b6826fbd" />
