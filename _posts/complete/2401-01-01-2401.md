...
⑶ Split any file into base64 text

<br>

```bash
gzip -c block4_adata_raw.h5ad | base64 | split -b 5M - block4_adata_raw.h5ad.gz.b64.part_

# How to decrypt
cat aa.txt ab.txt ac.txt ad.txt ae.txt af.txt ag.txt ah.txt ai.txt aj.txt \  
ak.txt al.txt am.txt an.txt ao.txt ap.txt aq.txt ar.txt as.txt at.txt \  
> block4_adata_raw.h5ad.gz.b64
tr -d '\r\n\t ' < block4_adata_raw.h5ad.gz.b64 | base64 -d > block4_adata_raw.h5ad.gz
gzip -tv block4_adata_raw.h5ad.gz
gunzip -c block4_adata_raw.h5ad.gz > block4_adata_raw.h5ad
```
