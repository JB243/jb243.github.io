...
> ① An LLM-based agentic coding tool made by Anthropic. The specific models are Sonnet (balanced) and Opus (high performance)
...
>> ○ **Step 4.** After accessing Antigravity, download Claude Code from the Marketplace
