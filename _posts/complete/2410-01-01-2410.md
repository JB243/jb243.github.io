...
So, what new `observational AI` could exist in the future? Considering **1)** the existence of a large amount of training data, **2)** exceeding human cognitive range, it might not be difficult to predict new fields. I still believe AlphaFold3 has not solved all the difficult parts of proteomics. For example, a diffusion model that predicts time-dependent molecular dynamics simulations or even byproducts, [organic chemical reactions](https://jb243.github.io/pages/1403) could soon emerge. Of course, attempts are already underway to understand chemical reactions through phylogenetic trees, as shown in the following figure. And examples could include: [an AI for logical inference](https://jb243.github.io/pages/1213) over an indeterminate, large-scale set of propositions (even current IMO solutions are nothing more than chains of about 100–150 propositions); an AI that goes beyond logical inference to create new axioms (transformers can’t do this, but humans can); an AI that alters just one fact and constructs a logical system that produces no contradictions with all other facts; an AI that predicts the weather with high accuracy; an AI that reconstructs the history of the universe; and an AI that predicts the macroeconomy one minute into the future (however, because historical indeterminacy is real, it likely wouldn’t be able to predict the macroeconomy an hour ahead).

<br>

<img width="726" height="412" alt="스크린샷 2026-08-11 오후 2 07 11" src="https://github.com/user-attachments/assets/afc797d8-4e2d-408b-b23a-c80d6e2e64b2" />
