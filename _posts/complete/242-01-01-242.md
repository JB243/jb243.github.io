...
> ○ Is it possible to find a simple mathematical function that closely describes a given specific geometric pattern? (<span style="color: #ffffff; background-color: #ee2323; font-family: Times New Roman;">►</span> [Math Art](https://www.youtube.com/watch?v=Ey-W3xwNJU8))
...
> ○ <span style="color: #ffffff; background-color: #ee2323; font-family: Times New Roman;">►</span> [Chladni figures](https://www.youtube.com/shorts/vzMH796WCCE): when a sand plate is vibrated at a specific frequency, the sand spontaneously forms patterns.
...
#### **1-4. Math Logic Problem**

> ○ Estimate the number of gas stations in the United States. ([Amazon Interview Question](https://www.youtube.com/shorts/99SsDQtnYRk))

➜ Based on where I live in Michigan, I come across roughly one gas station every three minutes by car. It takes about 20 hours to drive to Boston on the eastern edge of the country, and if we assume it takes about 40 hours to reach the western edge, then the rough estimate would be: 60 hours-distance² / 3 minutes-distance² = 1,440,000 gas stations. In reality, the actual number is said to be around 200,000. This sevenfold difference can be explained by the fact that many regions have much lower population density, and that the north-south distance is shorter than the east-west distance.
...
> ○ Estimate the number of cars in U.S. ([Amazon Interview Question](https://www.youtube.com/shorts/99SsDQtnYRk))

> ○ Estimate the number of people each gas station is responsible for on average ([Amazon Interview Question](https://www.youtube.com/shorts/99SsDQtnYRk))
...
> ○ Can emergent properties that are not observed at the previous stage be explained by Ramsey theory in large-scale networks?

> ○ [Open Challenges in Manifold Learning](https://jb243.github.io/pages/2158#3-type-2-manifold-learning)
...
> ○ Do sharks' organs consider hydrodynamics?

>> **➜ The intestines of sharks are [Tesla valves](https://jb243.github.io/pages/938). ([ref](https://royalsocietypublishing.org/rspb/article/288/1955/20211359/86276/Shark-spiral-intestines-may-operate-as-Tesla))**

> ○ Do animals have language?

>> **➜ [Project CETI](https://www.youtube.com/watch?v=wGulRccX-l4&pp=ygUT7Zal7Jyg6rOg656YIOyWuOyWtA%3D%3D): A project to translate sperm whale language.**

> ○ Why are about 90% of humans right-handed?

>> **➜ It is not due to a single specific gene, but likely an evolutionary outcome shaped by bipedal walking and the expansion of brain size.** ([ref](https://zdnet.co.kr/view/?no=20260520121315#_enliple))
...
> ○ Why are male animals more colorful in nature, but in humans, women are more flamboyant?

> ○ Why does [crown shyness](https://www.youtube.com/shorts/Bhr6WkYpew0), first observed in 1920, occur?

> ○ Humans have not yet unraveled the secrets of a dragonfly’s wings.

> ○ Couldn’t we use artificial intelligence to reconstruct what dinosaurs looked like from their bones?
...
>> **➜ Nasal cycle: Airflow alternates between the two nostrils, for example, 70% through the left and 30% through the right → a few hours later, 30% through the left and 70% through the right.**

>> **➜ Odor molecules are absorbed by the nasal mucosa at different rates, so having both faster and slower airflow can help us detect a wider variety of smells.**
...
> ○ The cause of type 1 diabetes has not yet been identified.
...
> ○ It has not been clarified specifically why centrioles are necessary.
...
>> **➜ [STARmap research](https://www.science.org/doi/10.1126/science.aat5691) in 2018**
...
> ○ Does [manifold](https://jb243.github.io/pages/2178) exist in bioinformatics?
...
> ○ Why is it when it rains heavily in some places and it doesn't rain right next to it? In other words, why does the rain keep starting and stopping?
...
> ○ Wolpert’s French Flag Problem: With only a small amount of observed data, infinitely many classification rules can fit the samples, showing that generalization to a simple “French-flag-like” boundary cannot be determined without additional assumptions (inductive bias).

> ○ Is the Physical Symbol System Hypothesis (PSSH)—which claims that a physical symbol system is a necessary and sufficient condition for producing general intelligent behavior—correct? Or does cognition transcend symbols?

> ○ Are fluid intelligence and crystallized intelligence truly distinct?

> ○ [The Bitter Lesson](http://www.incompleteideas.net/IncIdeas/BitterLesson.html): are models built on human knowledge ultimately inferior to from-scratch models?

> ○ Can reinforcement learning even change the model architecture itself?

> ○ Platonic Representation Hypothesis suggests that large-scale models trained across diverse views of the same system converge toward a common latent representation.
