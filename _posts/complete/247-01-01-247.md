...
○ AD (Alzheimer's Disease): 55M dementia worldwide
...
| Moderate variations  | XX                    | Otherwise                          | Female internal and external genitals                                                             | Variations in sex development such as premature shutdown of ovaries. Some caused by variation in sex-development genes.                     |
| Subtle variations    | XX                    | Ovaries                            | Female internal and external genitals                                                             | Subtle differences such as excess male sex hormone or polycystic ovaries.                                                                   |
| Typical female       | XX                    | Ovaries                            | Female internal and external genitals                                                             | Female secondary sexual characteristics                                                                                                     |

**Table 1.** DSD(disorder of sex development)

<br>

○ Herniated Disc

> ○ The vertebrae in the neck are called the cervical vertebrae, while those in the lower back are called the lumbar vertebrae.

> ○ Between each pair of vertebrae is an intervertebral disc, which acts as a cushion between the bones. A herniated disc occurs when part of the disc protrudes or ruptures through its outer layer.

> ○ For example, a C5–C6 cervical disc herniation or L4–L5 lumbar disc herniation refers to a herniated disc occurring between the corresponding vertebrae.

> ○ In South Korea, approximately 4 million people are affected by lumbar disc herniation.
...
**Table 2.** Liver-disease-related gene score
