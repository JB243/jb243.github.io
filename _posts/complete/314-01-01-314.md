...
> ② ViT is considered to correspond to holistic scene understanding in the inferotemporal cortex or facial recognition.
...
> ③ [UNI](https://www.nature.com/articles/s41591-024-02857-3), UNI2: Chen et al., Nature Medicine (2024). Uses DINOv2. Multi-purpose model applicable to 34 different tasks. 224 × 224 pixel patch → 1024-dim feature vector
...
> ⑭ CytoSyn: Generative model

> ⑮ H-Optimus-0, H-Optimus-1

> ⑯ STPath

> ⑰ PICASSO: uses SAE (providing explainability) 

> ⑱ OmiCLIP 

> ⑲ STORM 

> ⑳ [DeepSpot-M](https://www.medrxiv.org/content/10.64898/2026.06.19.26356060v1.full) 
...
> ㉔ [TissueFormer](https://www.biorxiv.org/content/10.64898/2026.07.31.741265v1.full.pdf) 

> ㉕ GHIST

> ㉖ [CytoFormer](https://www.sciencedirect.com/science/article/pii/S3117678X26000065)
...
> ④ Clinical Proteomic Tumor Analysis Consortium (CPTAC): WSIs

> ⑤ [TCGA](https://jb243.github.io/pages/1694): WSIs

> ⑥ EBRAINS: WSIs. 128 subtypes of rare brain tumors
...
> ⑧ [KEEP](https://www.cell.com/cancer-cell/fulltext/S1535-6108(26)00058-9): Utilizes disease knowledge graphs.
...
> ⑬ [Haiku](https://arxiv.org/html/2605.00925v1): Tri-omics foundation model (H&E, spatial proteomics (mIF), text)

> ⑭ [PRISM2](https://jiwoonoh.github.io/blog/2026/prism2-pathology) 
