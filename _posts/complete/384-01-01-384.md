...
Moreover, the optimal stopping problem ([Lemma 13](https://jb243.github.io/pages/895#3-laws-of-stochastic-control-theory)) is examined in depth within the framework of the Markov decision process (MDP) addressed in [stochastic control theory](https://jb243.github.io/pages/895). The secretary problem provides a well-known mathematical formulation of this concept.
