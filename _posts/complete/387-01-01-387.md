...
> ④ I think a Eureka moment seems to occur when quantum noise creates personalized knowledge and that personalized knowledge aligns with truth.

>> ○ If truth is extended to the social sciences, then religion and Einstein’s discoveries stand on the same level.
...
⑶ When free will does not manifest: [Simulation Cosmology](https://jb243.github.io/pages/2475)
