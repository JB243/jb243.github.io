...
> ⑹ **Theory 2.** In statistics, the variance of the sum of n independent random variables is simply n times the variance of one, whereas the variance of a single random variable multiplied by n is n² times larger.
...
⑸ Narcissists fear people who are both strong and weak at the same time. It's extremely difficult for them to assert control among such individuals, and it easily exposes the narcissist's own incompetence and worthlessness. Also, those individuals often don't even spare a glance at the narcissist.
