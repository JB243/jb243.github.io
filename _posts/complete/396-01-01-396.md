...
| optimization                          | game                                                                 |
|---------------------------------------|----------------------------------------------------------------------|
| $\min_{x \in X} f(x)$                 | $\min_{x_i \in X_i} f_i(x_i, x_{-i}), \ i \in [N]$                  |
| (strong) convexity                    | (strong) monotonicity                                                |
| <span style="color:red">(cvx)</span> global minimizer | <span style="color:red">(cvx)</span> NE: $f_i(x_i^*, x_{-i}^*) \le f_i(x_i, x_{-i}^*)$ for $i \in [N]$ |
| <span style="color:red">(ncvx)</span> B-/Clarke stationarity | <span style="color:red">(ncvx)</span> quasi-/Clarke NE |
...
> ② Humans can experience imprinting.
