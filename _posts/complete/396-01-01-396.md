...
> ⑴ Intuition is the ability to read a situation.

>> ① It's similar to the concept of Observation Haki in the manga One Piece.

>> ② Intuition is tacit knowledge involved in decision-making. It might be something expressed not as a proposition but rather in numbers or probabilities.

>> ③ According to the book Supercommunicators: How to Unlock the Secret Language of Connection, the more similar brainwaves are between people, the smoother the communication. There is a process of brainwave synchronization through social interaction. This is also an example of intuition.
...
>>>> ○ When I say to take on challenges, I don't mean to do so recklessly, but rather to properly understand the mechanism of challenge and success. Reckless challenges can make sense because a challenge is not just about luck, and the public's prejudice notion that it is reckless can be wrong.
