...
>> ○ Fiedler vector (algebraic connectivity): The eigenvector corresponding to the second smallest eigenvalue after λ<sub>1</sub> = 0. It represents the overall structure of the graph.
