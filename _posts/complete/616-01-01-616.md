...
> ② Normalization of Laplacian matrix: **D**<sup>-1/2</sup>**LD**<sup>-1/2</sup> 

> ③ **Characteristic 1.** Quadratic form: **f**<sup>T</sup>**Lf** = ∑<sub>e<sub>i,j</sub>, i < j</sub> (f(v<sub>i</sub>) - f(v<sub>j</sub>))<sup>2</sup>

> ④ **Characteristic 2.** **L** has an eigenvalue of 0.

> ⑤ **Characteristic 3.** L is symmetric and positive semi-definite. That is, L has n non-negative, real-valued eigen values.
