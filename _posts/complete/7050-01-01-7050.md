...
**1.** [**QC 1.** 实验 QC](#1-qc-1-实验-qc样品级质量控制)

**2.** [**QC 2.** 数据 QC](#2-qc-2-数据-qc序列级质量控制)

**3.** [**QC 3.** 过滤](#3-qc-3-过滤)

**4.** [**QC 4.** 比对](#4-qc-4-对齐方式)

**5.** [**QC 5.** 标准化](#5-qc-5-标准化)

**6.** [**QC 6.** 批次效果](#6-qc-6-批量效果)

**7.** [**Common 1.**聚类](#7-common-1-集群)

**8.** [**Common 2.**差异表达基因(DEG)分析](#8-common-2-差异表达基因-deg-分析)

**9.** [**Common 3.** 基因集富集](#9-common-3-基因集富集)

**10.** [**Common 4.**基因相互作用分析](#10-common-4-基因相互作用分析)

**11.** [**Common 5.**细胞类型映射分析](#11-common-5-细胞类型映射分析)

**12.** [**Advanced 1.** 选择性剪接分析（AS 分析）](#12-advanced-1-选择性剪接分析as-分析)

**13.** [**Advanced 2.** 轨迹分析](#13-advanced-2-轨迹分析)

**14.** [**Advanced 3.** 表观基因组学分析](#14-advanced-3-表观基因组学分析)

**15.** [**Advanced 4.** 特殊转录组学分析](#15-advanced-4-特殊转录组学分析)

**16.** [**Advanced 5.** 数据库利用率](#16-advanced-5-数据库利用率)
