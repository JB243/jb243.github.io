...
**2.** **类型 1.** [主成分分析 (PCA)](#2-类型-1-principal-component-analysis-pca)

**3\.类型 2.** [SNE、对称-SNE、tSNE](#3-类型-2-sne-对称--sne-tsne)

**4\.类型 3.** [UMAP](#4-类型-3-umap)

**5\.类型 4.** [SVD](#5-类型-4-奇异值分解-svd)

**6\.类型 5.** [ICA](#6-类型-5-ica)

**7. 类型 6.** [PPCA](#7-类型-6-ppca)

**8. 类型 7.** [CCA](#8-类型-7-cca)
