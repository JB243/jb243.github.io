...
>> ○ 3<sup>rd</sup>. At least one pair will have the gene located in the middle (because double crossing over is very rare).

>> ○ 4<sup>th</sup>. Calculate the crossover rate between the middle gene and each of the other genes.
