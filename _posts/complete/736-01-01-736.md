...
⑾ **Example 8.** `Demonstrating Circular Motion as Simple Harmonic Motion`: Simple harmonic motion can be expressed using sine and cosine functions, and the rotational motion of a rigid body can also be expressed using sine and cosine functions. Therefore, if their phases are properly aligned — or, in the video, if the timing is synchronized — a combined system of simple harmonic motions that individually move only in straight lines can create the optical illusion of rigid body motion.
...
⑿ **Example 9.** By applying **Example 8**, a straight rod can be made to pass through a curved trajectory → the emergence of the concept of a [manifold](https://jb243.github.io/pages/2178).

<br>

<p><iframe src="https://www.youtube.com/embed/6XBvjpQAMLA" width="852" height="480" frameborder="0" allowfullscreen=""></iframe></p>
...
⒁ **Example 11.** `Atomic Oscillations`
