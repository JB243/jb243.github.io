...
**c.** [Molecular Biology Exam Problems](https://jb243.github.io/pages/1151)
...
>>> ○ L (Linking number; Lk): The number of loops. Conserved during torsional stress calculations, with counterclockwise (+) rotation.

>>> ○ T (Twist number; Tw): The number of helical turns. DNA is inherently right-handed, so it has counterclockwise (+) torsional stress.

>>> ○ W (Writhe number; Wr): The number of supercoils.

>>> ○ [White’s law](https://www.sciencedirect.com/topics/biochemistry-genetics-and-molecular-biology/dna-topology): L = T + W
...
>>>> ○ _E. coli_ topoisomerase IV, a type II topoisomerase, is specialized in resolving catenanes formed by the interlocking of two daughter DNA molecules.
...
>> ○ Eukaryotes: _RNAase H_, _FEN1_ (flap endonuclease)  

<br>

<img width="220" height="309" alt="스크린샷 2026-01-23 오후 6 33 20" src="https://github.com/user-attachments/assets/bb558e52-41ce-4cd2-9927-ceaf438da6e1" />

**Figure 4.** RNA primer removal in Escherichia coli (removed in the 5' → 3' direction).
...
**Figure 5.** Meselson-Stahl's experiment
...
>> ○ Inhibition of telomerase activity: siRNA-mediated suppression of TERT and TERC, the components of telomerase

<br>

![image](https://github.com/user-attachments/assets/5c1b0efd-9499-4b79-9809-87127080e9bd)

**Figure 6.** Mechanism of exposed 3' terminus in telomeres and telomerase
...
**Figure 7.** rolling-circle replication
...
>>> ○ Circular DNA that exists outside of chromosomes, contributing to high copy numbers of specific genes in cancer cells.

>>> ○ Detected in 17.1 % of all tumors.
...
>> ○ ASO(antisense oligonucleotide): short(15-25 bp) synthetic nucleic acid 
...
| RNA type | read ratio | RNA number |
| --- | --- | --- |
| lncRNA | 15.43 | 15,880 |
| microRNA | 0.35 | 1,352 |
| miscRNA | 1.25 | 1,009 |
...
**Table 2.** The distribution of non-coding RNA (95-99%)
...
**Figure 11.** splice donor, splice acceptor
...
**Figure 12.** Group I self-splicing
...
**Figure 13.** Group II self-splicing
...
**Figure 14.** Types of mRNA splicing

<br>

>>> ○ **SE (Skipped Exon, Exon Skipping)**: ~40%. When an entire specific exon is either included or excluded.
...
>>> ○ In addition, there are also alternative promoters, alternative poly(A) sites, MXE-AFE, and MXE-ALE. 
...
**Figure 16.** SL trans-splicing process
...
**Figure 17.** Composition of lactose operon 
...
>> ○ The [maltose operon](https://nate9389.tistory.com/1223#:~:text=%EB%8F%99%EC%9D%BC%ED%95%9C%20%EC%86%8C%ED%8F%AC%EC%B2%B4%20%EB%82%B4%EB%B6%80-,13,-.%20%EB%8B%A4%EC%9D%8C%EC%9D%80%20%EB%8C%80%EC%9E%A5%EA%B7%A0%EC%9D%98) also functions very similarly to the lactose operon.
...
**Figure 18.** Composition of tryptophan operon
...
**Figure 19.** DNA sequence of the trp operon
...
**Figure 20.** Leader peptide mRNA sequence of the trp operon
...
**Figure 21.** Hairpin formation in the attenuation regulator mechanism of trp operon
...
**Figure 22.** PIC formation process
...
**Figure 23.** The deamination of cytosine 
...
**Figure 24.** Global methylation map
...
**Figure 25.** DNA methylation and transcription inactivation 
...
>>> ○ Acetyl groups bind exclusively to lysine residues on the histone tail.  
...
>>> ○ The acetyl group and the methyl group compete for the same amino group site.

>> ○ Histone acetyltransferase (HAT)

>>> ○ Part of the general transcription factor complex.
...
>>> ○ Opposition of histone acetylation
...
>>> ○ The effect on transcription (activation or inactivation) varies depending on the phosphorylation site.
...
**Table 3.** Effects of histone modifications on activation / inhibition

For example, H3K27 refers to the 27th lysine amino acid (Lys) in the H3 histone.

<br>

>> ○ [Epigenomics Sequencing](https://jb243.github.io/pages/1431), [Epigenetics Library](https://jb243.github.io/pages/398)
...
**Table 4.** The comparison of miRNA and siRNA
...
>> ○ Regulation of thiMD gene expression by a TPP riboswitch in Escherichia coli

<br>

<img width="489" height="526" alt="스크린샷 2025-12-23 오후 10 42 18" src="https://github.com/user-attachments/assets/9f39925e-d33d-4fc3-af6a-b3d58e74da25" />

**Figure 27.** TPP riboswitch

<br>

>>> ○ The TPP riboswitch regulates translation initiation by blocking ribosome binding to the RBS.

>>> ○ When TPP is present, expression of the thiMD gene is repressed.

>>> ○ Because thiMD is involved in **TPP biosynthesis**, the riboswitch automatically adjusts (feedback-regulates) the amount of TPP produced.
...
> ③ Initiation of Poliovirus

>> ○ Translation initiation of poliovirus mRNA is induced by the binding of initiation factors to the IRES region.

>> ○ The IRES of poliovirus induces translation initiation in eukaryotic cells.
...
**Figure 28.** Position of reading frames within mRNA.
...
**Figure 29.** Signal sequence logo of Hsp90
...
>> ○ 1<sup>st</sup>. Initiation of translation

>> ○ 2<sup>nd</sup>. Co-translation: The N-terminal signal peptide of the nascent polypeptide binds to the SRP in the cytosol.

>> ○ 3<sup>rd</sup>. Targeting to ER: SRP delivers the ribosome–nascent polypeptide complex to the SRP receptor on the ER membrane.

>> ○ 4<sup>th</sup>. Docking to translocon: The ribosome binds to the translocon (requires GTP).

>> ○ 5<sup>th</sup>. Resumption of translation: The polypeptide is translocated into the ER lumen as translation resumes.

>> ○ 6<sup>th</sup>. Post-translocation processing: Signal peptidase cleaves the signal peptide.
...
>>> ○ The core oligosaccharide attached to dolichol in the endoplasmic reticulum (ER) membrane is transferred to the target protein by oligosaccharyltransferase.
...
**Table 6.** Comparison between phosphorylation and sulfation 
...
<img width="468" height="673" alt="스크린샷 2026-08-22 오후 4 01 30" src="https://github.com/user-attachments/assets/d042fe0e-0a96-4fbf-9cab-b0538ccfedeb" />

**Figure 30.** Protein splicing

<br>

> ① Inteins are autocatalytic protein elements that mediate protein-splicing reactions.

> ② Split inteins exist as two fragments—an N-terminal intein fragment (Int<sub>N</sub>) and a C-terminal intein fragment (Int<sub>C</sub>). When these fragments associate, they form a catalytically active intein.

> ③ The N-terminal residue of the intein is cysteine (Cys, C), while its C-terminal residue is asparagine (Asn, N).

> ④ The residue on the C-terminal extein side that participates in protein splicing is the sulfur-containing amino acid cysteine (Cys, C).

> ⑤ Removal of the intein from the protein precursor results in the formation of a mature protein.
