...
**1.** [Central Theory](#1-central-theory)
...
**7.** [Processing of Proteins After Translation](#7-processing-of-proteins-after-translation)
...
![image](https://github.com/JB243/jb243.github.io/assets/55747737/29be2e19-4748-4881-bd5f-44449cb7e184)

![image](https://github.com/JB243/jb243.github.io/assets/55747737/1f014b9d-da11-4c2b-ab38-99f0e4216b0d)
...
⑴ 1<sup>st</sup>. Yawning DNA helix
...
![image](https://github.com/JB243/jb243.github.io/assets/55747737/0bf12569-bd12-4ee7-a41e-b6cbf0452be3)
...
>>> ○ β<sub>2</sub> **:** Sliding DNA clamp-related.

>> ○ Sliding clamp 

<br>

![image](https://github.com/JB243/jb243.github.io/assets/55747737/72f0a04b-deb5-42b4-9f30-05421bcc18fe)
...
![image](https://github.com/JB243/jb243.github.io/assets/55747737/740691e1-e2b7-4eb7-a8c4-dcb85447a111)
...
![image](https://github.com/JB243/jb243.github.io/assets/55747737/afba5f05-9ae4-4ac5-ad75-f0c848eb0260)
...
![image](https://github.com/JB243/jb243.github.io/assets/55747737/06f6d447-a02f-4d28-943b-2c188b350269)
...
![image](https://github.com/JB243/jb243.github.io/assets/55747737/8b0cc184-864e-443c-b4ba-85381c4e7435)
...
![image](https://github.com/JB243/jb243.github.io/assets/55747737/9b3dfa09-399c-4828-a3b9-2a6c54bfeffc)
...
⑷ 2<sup>nd</sup>. Elongation of the RNA chain **:** RNA polymerase polymerizes RNA base complementary to DNA base (template strand) of gene into 5 '→ 3' to produce RNA as a product of transcription
...
⑹ 4<sup>th</sup>. mRNA processing (eukaryotic cells only) **:** Mature mRNA is transferred to the cytoplasm through nuclear pores, degrades and translates

> ① 1<sup>st</sup>. Capping

<br>

![image](https://github.com/JB243/jb243.github.io/assets/55747737/2a9a396a-8709-4568-90fc-2ca6db13762d)

**Figure. 8.** 5'-cap

<br>

>> ○ Start at the same time with transcription

>> ○ 7-MeG, a methylated guanosine derivative at the 5 'end of the pre-mRNA, is linked by a 5'-5' bond (5 'carbon-3 phosphate groups-5' carbon)

>> ○ 5'-MeG binds to CBC (cap binding complex)

>> ○ Cap **:** Help to escape the nucleus. protect mRNA from nucleases. Site recognized by protein synthesis machinery

> ② 2<sup>nd</sup>. mRNA editing **:** apolipoprotein B protein is representative

>> ○ Human apolipoprotein B protein becomes 100 kDa Apo-B100 in the liver

>> ○ Human apolipoprotein B protein becomes 48 kDa Apo-B48 in the small intestine

>> ○ Cytidine deaminase deamines 5'-CAG-3 'to 5'-UAG-3' in RNA → stop codon is generated in a new position

> ③ 3<sup>rd</sup>. poly A tail formation

>> ○ poly A tail is associated with eukaryotic transcription terminator

>> ○ PBP (poly A binding protein) attaches A base after 5'-AAUAAA-3 '

>> ○ poly A tail helps mRNA move from the nucleus to the cytoplasm and increases mRNA stability

> ④ 4<sup>th</sup>. Splicing **:** Only Exon Sites Connected by Spliceosomes. ATP required

>> ○ Exon **:** Sites that encode substantial genetic information and untranslated regions (UTRs)

>> ○ intron (intron) **:** Encrypting nonsensical information. Presumably more profound

>>> ○ **Meaning 1.** Having meaningless repetitive sequences is intended to maintain the distance between DNA in the chromatin

>> ○ Splicosomes (snRNP) **:** composed of snRNA

>> ○ u1 snRNP + u2 snRNP + u4 snRNP + u5 snRNP + u6 snRNP → u1 snRNP + u4 snRNP removal
...
> ⑤ Selective splicing **:** Only some exons on one pre-mRNA are selected to form multiple combinations of mRNAs

>> ○ More than 95% of genes with introns in humans have selective splicing

>> ○ Eliminates normal exons from splicing faults → can cause cancer

>> ○ Splicing results in quick stop codons → Eliminates abnormal mRNA with NMD (nonsense-mediated mRNA decay)

> ⑥ Exon shuffling **:** Crossover between different genes creates a new combination of exons  

> ⑦ mRNA stability (life regulation)

>> ○ Long-lived mRNA detoxified with more protein

>> ○ Prokaryotic mRNA has a lifespan of about 2 to 3 minutes

>> ○ Eukaryotic mRNA has a lifetime of days to weeks

>> ○ **Example 1.** Hemoglobin mRNA remains undegraded as long as red blood cells are alive  

>> ○ **Example 2.** Transferrin **:** Iron introduction-transport protein

>>> ○ Iron response element (IRE) **:** Present downstream of the coding site. AT-rich sequence

>>> ○ Fe<sup>3+</sup> ↑ **:** IRE-BP is inactive → poly A sequence removed from transferrin mRNA → mRNA is degraded

>>> ○ Fe<sup>3+</sup> ↓ **:** IRE-BP is active → poly A sequence protection of transferrin mRNA → mRNA is stabilized → expression
...
![image](https://github.com/JB243/jb243.github.io/assets/55747737/5f8ad8b2-f18a-408f-af05-234d19feb374)

**Figure. 9.** Lactose Operon Gene Composition
...
>>> ○ lac I<sup>-</sup> **:** Inhibitor defective and unable to engage working area. Always active

>>> ○ lac I<sup>S</sup> **:** Lactose did not bind to the inhibitor. Always inactive

>>> ○ lac O<sup>c</sup> **:** Defective operating part prevents the suppressor from engaging the operating area. Always active

>>> ○ lac Z<sup>-</sup> **:** Encrypt the defective lac Z. Β-galactosidase expression independent of operon ×
...
![image](https://github.com/JB243/jb243.github.io/assets/55747737/bd16baaf-0939-41d8-9855-29dd1dafb790)

**Figure. 10.** Tryptophan operon gene composition</center>
...
![image](https://github.com/JB243/jb243.github.io/assets/55747737/0ab6cf0b-693b-4b9c-8806-bfefc1981767)

**Figure 11.** DNA sequence of the trp operon

<br>

![image](https://github.com/JB243/jb243.github.io/assets/55747737/41e88962-81ed-438b-838a-5038f2b0cdc3)

**Figure 12.** Leader peptide mRNA sequence of the trp operon
...
![image](https://github.com/JB243/jb243.github.io/assets/55747737/696bd6a3-2e5f-4e02-a2b9-0fd1fcd7d39a)

**Figure. 13.** Hairpin Formation in the Attenuation Regulator of trp Operon
...
>>> ○ TFIIF **:** RNA pol Ⅱ binding

>>> ○ TFIIH **:** Phosphorylation of CTD of RNA pol Ⅱ in phosphorus → Helicase activity, RNA pol II unlike Heliocase activity ×
...
![image](https://github.com/JB243/jb243.github.io/assets/55747737/3be72d17-745f-42c7-9666-3f6bdfeadcee)

**Figure. 14.** Global methylation map

<br>

>> ○ Chromatin with methyl groups condenses and inactivates transcription (degree of expression) **:** Calm dye ＞ Heterochromatin)

>>> ○ Due to the large number of C bases at the promoter and transcription factor binding sites (eg **:** GC box)

>> ○ Representative concepts of epigenetics
...
![image](https://github.com/JB243/jb243.github.io/assets/55747737/53ff9a2a-14ef-44d6-94de-301516ecb439)
...
![image](https://github.com/JB243/jb243.github.io/assets/55747737/f6d33b6d-f6bd-4c86-81e6-a5d63485fa3d)
...
![image](https://github.com/JB243/jb243.github.io/assets/55747737/dfef8a07-6920-467c-8fc8-833c43e095d8)
...
![image](https://github.com/JB243/jb243.github.io/assets/55747737/1b2915eb-2460-48a3-8843-d1351bd82086)

**Figure 16.** Position of reading frames within mRNA.
...
![image](https://github.com/JB243/jb243.github.io/assets/55747737/1bde6b55-a783-4981-93da-07a958303e5b)

**Figure. 17.** Signal sequence of Hsp90.
