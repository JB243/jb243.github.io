...
> ② Split inteins exist as two fragments—an N-terminal intein fragment (IntN) and a C-terminal intein fragment (IntC). When these fragments associate, they form a catalytically active intein.
