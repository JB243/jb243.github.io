...
>> ○ lncRNA and ncRNA: Non-coding RNA (e.g., pseudo genes are transcribed but not translated). lncRNAs lack exons, have fewer isoforms, are lowly expressed, and exhibit high tissue specificity.
...
**Figure 12.** splice donor, splice acceptor
...
>>> ○ The methyl group attaches to the C base: The C base is prone to becoming a T base through deamination.
...
**Figure 21.** Global methylation map
...
**Figure 22.** DNA methylation and transcription inactivation 
...
**Figure 24.** Position of reading frames within mRNA.
...
**Figure 25.** Signal sequence of Hsp90
