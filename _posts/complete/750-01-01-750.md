## **Optics Chapter 4. Quantum Optics Part 2**
...
>> ○ Note that natural light vibrates in all directions perpendicular to the direction of propagation.
...
>> ○ [Brewster angle](https://nate9389.tistory.com/2482): incident angle when certain polarization components are not reflected (reflection coefficient Γ  = 0). It exists when the magnetic permeability is the same and the permittivity differs, but does not exist when the magnetic permeability differs.
