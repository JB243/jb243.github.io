...
> ① Definition: A hypothetical one-dimensional topological defect that may have formed during symmetry-breaking phase transitions in the early universe.

> ② Pulsar Timing Arrays (PTAs): Study cosmic strings as sources of gravitational radiation. Recently, PTAs have reported observations consistent with a stochastic gravitational-wave background.

> ③ Garfinkle–Vachaspati Strings

<br>

<img width="453" height="94" alt="스크린샷 2026-02-09 오전 10 01 30" src="https://github.com/user-attachments/assets/0e796d50-7997-41d5-9794-08d240cf6a87" />

<br>

>> ○ $\omega_N$: Frequency

>> ○ $P_N$: Power spectrum of the $N$-th harmonic emitted by a cosmic string loop

>> ○ $I(N,\alpha)$: Core integral evaluated over the unit sphere $S^2$

>> ○ $\mu$: Mass per unit length

>> ○ $e_1, e_2$: Projection factors

>> ○ $\hat{\mathbf a}, \hat{\mathbf b}$: Three-dimensional unit vectors characterizing the string trajectory

>> ○ $\alpha$: Loop opening angle between the two vectors
