...
>> ○ Examples: β-actin (ACTB), tubulin, GAPDH, B2M, RPL11, RPL13A, 18S rRNA (most reliable).  
...
<img width="573" height="426" alt="스크린샷 2026-05-29 오후 5 22 53" src="https://github.com/user-attachments/assets/97377e1b-7caf-4b5a-a799-959e0868ed23" />

**Figure 11.** NHEJ and HDR
...
**Figure 12.** CRISPR/Cas9 Technology Diagram

<br>

> ⑤ **Application 1.** [Perturb-seq](https://jb243.github.io/pages/1431#1-type-1-identifying-gene-function)

>> ○ sgRNA/dCas9-BFP-KRAB complex → binding to the target promoter → KAP1 complex → heterochromatinization (suppression of gene expression)

>> ○ Perturbation screening can be performed using different guide RNAs.

> ⑥ **Application 2.** Gene therapy: editing alleles that cause rare diseases

> ⑦ **Application 3.** Temporal sequencing (e.g., [Record-seq](https://www.nature.com/articles/s41596-019-0253-4)): recording events within spacers
...
**Figure 13.** Comparison between AAV and LNP
...
*Input: 2015.07.03 21:57*

*Modify: 2016.05.25 00:18*
