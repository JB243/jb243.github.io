...
>>> ○ When plasma glucose exceeds ~200 mg/dL, the filtered load of glucose becomes greater than the tubules’ reabsorptive capacity (Tm), so glucose appears in the urine (glucosuria).
