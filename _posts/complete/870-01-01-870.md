...
> ② It can be expressed as: h<sub>t</sub> = tanh(W<sub>x</sub>x<sub>t</sub> + W<sub>h</sub>h<sub>t-1</sub> + b)
...
>> ○ [Why gradient clipping speeds up model training](https://openreview.net/pdf?id=BJgnXpVYwS)
...
<img width="856" height="438" alt="스크린샷 2026-09-10 오후 6 24 25" src="https://github.com/user-attachments/assets/604d993c-1fff-4d84-bbc6-13c1c1d9b8d4" />
