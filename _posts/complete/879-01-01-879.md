...
<img width="186" height="108" alt="스크린샷 2025-09-21 오후 8 12 29" src="https://github.com/user-attachments/assets/0680a320-a2fe-468c-a9d0-fa81a8061789" />

<br>

⑸ **Type 5.** Operator norm

<br>

<img width="169" height="44" alt="스크린샷 2025-09-21 오후 8 12 48" src="https://github.com/user-attachments/assets/93bd3d29-21b5-437c-b0d6-2bcde236cd12" />
...
<img width="168" height="62" alt="스크린샷 2025-10-12 오후 2 58 52" src="https://github.com/user-attachments/assets/dcb36c8a-a351-4f59-88b3-c520e9251862" />

<br>

⑺ **Type 7.** Spectral norm
...
⒇ **Type 31.** Fréchet Inception Distance (FID)

⒇ **Type 32.** Kernel Inception Distance (KID)

⒇ **Type 33.** Cramér distance: A special case of maximum-mean distance (MMD)

⒇ **Type 34.** Energy distance: A special case of maximum-mean distance (MMD)

⒇ **Type 35.** Chamfer distance

⒇ **Type 36.** Average Symmetric Surface Distance (ASSD)

⒇ **Type 37.** Robinson–Foulds (RF) distance
...
> ③ Jaccard distance: 1 - Jacquard similarity. Definition of distance satisfied. A method used for the distance of nominal variables.
...
> ① Clusters based on standard molecular fingerprints.

> ② Tanimoto ≥ 0.7-0.8: highly similar analogs and should remain in the same split.

> ③ Tanimoto ≥ 0.5-0.6: moderately similar.

⒇ **Type 23.** Stoyan’s mark-correlation function

⒇ **Type 24.** Morisita-Horn index

⒇ **Type 25.** Bounded Lipschitz (or Dudley) metric

⒇ **Type 26.** PSNR: Image similarity

⒇ **Type 27.** FSIM: Image similarity. Variations in SSIM

⒇ **Type 28.** NPMI: Similar to IoU.

⒇ **Type 29.** Global Lee’s L: Bivariate spatial correlation metric.
