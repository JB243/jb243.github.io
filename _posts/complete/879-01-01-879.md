...
⒃ **Type 16.** [Faiss](https://github.com/facebookresearch/faiss): Faiss is a library for efficient similarity search and clustering of dense vectors. Developed by Meta.

⒄ **Type 17.** Smith–Waterman similarity: Used for evaluating the similarity between nucleic acid or amino acid sequences.

⒅ **Type 18.** Maximal information coefficient (MIC)

⒆ **Type 19.** Spectral Similarity: Compares eigenvectors when comparing matrices A and B. Related to the Laplacian matrix and [graph theory](https://jb243.github.io/pages/616).
