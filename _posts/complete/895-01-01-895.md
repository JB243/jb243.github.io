...
> ① If Y is independent of the state and does not appear directly in the reward function, then Y is irrelevant to the decision problem: any rule that ignores y performs at least as well as one that depends on it.
...
> ④ It is mathematically proven that in dynamic programming problems, **memoryless strategies** alone are sufficient to achieve optimal expected rewards — forming a theoretical foundation for stochastic control theory.
