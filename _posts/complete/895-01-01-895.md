...
>>>> ○ For s < t, 𝔼[X<sub>t</sub>​ ㅣ ℱ<sub>s</sub>] = X<sub>t</sub> ​ also holds, because X<sub>s</sub> ​is ℱ<sub>s</sub>-measurable and ℱ<sub>s</sub> ⊆ ℱ<sub>t</sub> implies X<sub>s</sub> is ℱ<sub>t</sub>-measurable. 
