...
>> ○ **Application 5.** Generally, P<sup>g</sup>(X<sub>t+1</sub> ∈ A ㅣ H<sub>t</sub>, u<sub>t</sub>) ≠ P<sup>g</sup>(X<sub>t+1</sub> ∈ A ㅣ y<sub>t</sub>, u<sub>t</sub>), H<sub>t</sub> = (Y<sub>0:t</sub>, U<sub>0:t-1</sub>) (∵ dependence on u<sub>0:t-1</sub>)
