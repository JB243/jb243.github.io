...
> ③ If L(π) is a concave function, L(π) ≤ inf<sub>i∈I</sub> {α<sub>i</sub> π + β<sub>i</sub>}, α<sub>i</sub>, β<sub>i</sub> ∈ ℝ is established. That is, the tangent line is above the function graph.
